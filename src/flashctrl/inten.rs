...
pub type EeRwDoneR = crate::BitReader;
...
pub type EeProgDoneR = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn ee_rw_done(&self) -> EeRwDoneR {
        EeRwDoneR::new(((self.bits >> 26) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn ee_prog_done(&self) -> EeProgDoneR {
        EeProgDoneR::new(((self.bits >> 28) & 1) != 0)
    }
}
