...
pub type P0_0reiR = crate::BitReader;
...
pub type P0_1reiR = crate::BitReader;
...
pub type P0_2reiR = crate::BitReader;
...
pub type P0_3reiR = crate::BitReader;
...
pub type P0_4reiR = crate::BitReader;
...
pub type P0_5reiR = crate::BitReader;
...
pub type P0_6reiR = crate::BitReader;
...
pub type P0_7reiR = crate::BitReader;
...
pub type P0_8reiR = crate::BitReader;
...
pub type P0_9reiR = crate::BitReader;
...
pub type P0_10reiR = crate::BitReader;
...
pub type P0_11reiR = crate::BitReader;
...
pub type P0_12reiR = crate::BitReader;
...
pub type P0_13reiR = crate::BitReader;
...
pub type P0_14reiR = crate::BitReader;
...
pub type P0_15reiR = crate::BitReader;
...
pub type P0_16reiR = crate::BitReader;
...
pub type P0_17reiR = crate::BitReader;
...
pub type P0_18reiR = crate::BitReader;
...
pub type P0_19reiR = crate::BitReader;
...
pub type P0_20reiR = crate::BitReader;
...
pub type P0_21reiR = crate::BitReader;
...
pub type P0_22reiR = crate::BitReader;
...
pub type P0_23reiR = crate::BitReader;
...
pub type P0_24reiR = crate::BitReader;
...
pub type P0_25reiR = crate::BitReader;
...
pub type P0_26reiR = crate::BitReader;
...
pub type P0_27reiR = crate::BitReader;
...
pub type P0_28reiR = crate::BitReader;
...
pub type P0_29reiR = crate::BitReader;
...
pub type P0_30reiR = crate::BitReader;
...
pub type P0_31reiR = crate::BitReader;
impl R {
    ...
    pub fn p0_10rei(&self) -> P0_10reiR {
        P0_10reiR::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    pub fn p0_11rei(&self) -> P0_11reiR {
        P0_11reiR::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    pub fn p0_12rei(&self) -> P0_12reiR {
        P0_12reiR::new(((self.bits >> 12) & 1) != 0)
    }
    ...
    pub fn p0_13rei(&self) -> P0_13reiR {
        P0_13reiR::new(((self.bits >> 13) & 1) != 0)
    }
    ...
    pub fn p0_14rei(&self) -> P0_14reiR {
        P0_14reiR::new(((self.bits >> 14) & 1) != 0)
    }
    ...
    pub fn p0_15rei(&self) -> P0_15reiR {
        P0_15reiR::new(((self.bits >> 15) & 1) != 0)
    }
    ...
    pub fn p0_16rei(&self) -> P0_16reiR {
        P0_16reiR::new(((self.bits >> 16) & 1) != 0)
    }
    ...
    pub fn p0_17rei(&self) -> P0_17reiR {
        P0_17reiR::new(((self.bits >> 17) & 1) != 0)
    }
    ...
    pub fn p0_18rei(&self) -> P0_18reiR {
        P0_18reiR::new(((self.bits >> 18) & 1) != 0)
    }
    ...
    pub fn p0_19rei(&self) -> P0_19reiR {
        P0_19reiR::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    pub fn p0_20rei(&self) -> P0_20reiR {
        P0_20reiR::new(((self.bits >> 20) & 1) != 0)
    }
    ...
    pub fn p0_21rei(&self) -> P0_21reiR {
        P0_21reiR::new(((self.bits >> 21) & 1) != 0)
    }
    ...
    pub fn p0_22rei(&self) -> P0_22reiR {
        P0_22reiR::new(((self.bits >> 22) & 1) != 0)
    }
    ...
    pub fn p0_23rei(&self) -> P0_23reiR {
        P0_23reiR::new(((self.bits >> 23) & 1) != 0)
    }
    ...
    pub fn p0_24rei(&self) -> P0_24reiR {
        P0_24reiR::new(((self.bits >> 24) & 1) != 0)
    }
    ...
    pub fn p0_25rei(&self) -> P0_25reiR {
        P0_25reiR::new(((self.bits >> 25) & 1) != 0)
    }
    ...
    pub fn p0_26rei(&self) -> P0_26reiR {
        P0_26reiR::new(((self.bits >> 26) & 1) != 0)
    }
    ...
    pub fn p0_27rei(&self) -> P0_27reiR {
        P0_27reiR::new(((self.bits >> 27) & 1) != 0)
    }
    ...
    pub fn p0_28rei(&self) -> P0_28reiR {
        P0_28reiR::new(((self.bits >> 28) & 1) != 0)
    }
    ...
    pub fn p0_29rei(&self) -> P0_29reiR {
        P0_29reiR::new(((self.bits >> 29) & 1) != 0)
    }
    ...
    pub fn p0_30rei(&self) -> P0_30reiR {
        P0_30reiR::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Status of Rising Edge Interrupt for P0\\[31\\]. 0 = No rising edge detected. 1 = Rising edge interrupt generated."]
    #[inline(always)]
    pub fn p0_31rei(&self) -> P0_31reiR {
        P0_31reiR::new(((self.bits >> 31) & 1) != 0)
    }
}
#[doc = "GPIO Interrupt Status for Rising edge for Port 0.\n\nYou can [`read`](crate::Reg::read) this register and get [`statr0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Statr0Spec;
impl crate::RegisterSpec for Statr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`statr0::R`](R) reader structure"]
impl crate::Readable for Statr0Spec {}
#[doc = "`reset()` method sets STATR0 to value 0"]
impl crate::Resettable for Statr0Spec {}
