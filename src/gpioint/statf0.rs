...
pub type P0_0feiR = crate::BitReader;
...
pub type P0_1feiR = crate::BitReader;
...
pub type P0_2feiR = crate::BitReader;
...
pub type P0_3feiR = crate::BitReader;
...
pub type P0_4feiR = crate::BitReader;
...
pub type P0_5feiR = crate::BitReader;
...
pub type P0_6feiR = crate::BitReader;
...
pub type P0_7feiR = crate::BitReader;
...
pub type P0_8feiR = crate::BitReader;
...
pub type P0_9feiR = crate::BitReader;
...
pub type P0_10feiR = crate::BitReader;
...
pub type P0_11feiR = crate::BitReader;
...
pub type P0_12feiR = crate::BitReader;
...
pub type P0_13feiR = crate::BitReader;
...
pub type P0_14feiR = crate::BitReader;
...
pub type P0_15feiR = crate::BitReader;
...
pub type P0_16feiR = crate::BitReader;
...
pub type P0_17feiR = crate::BitReader;
...
pub type P0_18feiR = crate::BitReader;
...
pub type P0_19feiR = crate::BitReader;
...
pub type P0_20feiR = crate::BitReader;
...
pub type P0_21feiR = crate::BitReader;
...
pub type P0_22feiR = crate::BitReader;
...
pub type P0_23feiR = crate::BitReader;
...
pub type P0_24feiR = crate::BitReader;
...
pub type P0_25feiR = crate::BitReader;
...
pub type P0_26feiR = crate::BitReader;
...
pub type P0_27feiR = crate::BitReader;
...
pub type P0_28feiR = crate::BitReader;
...
pub type P0_29feiR = crate::BitReader;
...
pub type P0_30feiR = crate::BitReader;
...
pub type P0_31feiR = crate::BitReader;
impl R {
    ...
    pub fn p0_10fei(&self) -> P0_10feiR {
        P0_10feiR::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    pub fn p0_11fei(&self) -> P0_11feiR {
        P0_11feiR::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    pub fn p0_12fei(&self) -> P0_12feiR {
        P0_12feiR::new(((self.bits >> 12) & 1) != 0)
    }
    ...
    pub fn p0_13fei(&self) -> P0_13feiR {
        P0_13feiR::new(((self.bits >> 13) & 1) != 0)
    }
    ...
    pub fn p0_14fei(&self) -> P0_14feiR {
        P0_14feiR::new(((self.bits >> 14) & 1) != 0)
    }
    ...
    pub fn p0_15fei(&self) -> P0_15feiR {
        P0_15feiR::new(((self.bits >> 15) & 1) != 0)
    }
    ...
    pub fn p0_16fei(&self) -> P0_16feiR {
        P0_16feiR::new(((self.bits >> 16) & 1) != 0)
    }
    ...
    pub fn p0_17fei(&self) -> P0_17feiR {
        P0_17feiR::new(((self.bits >> 17) & 1) != 0)
    }
    ...
    pub fn p0_18fei(&self) -> P0_18feiR {
        P0_18feiR::new(((self.bits >> 18) & 1) != 0)
    }
    ...
    pub fn p0_19fei(&self) -> P0_19feiR {
        P0_19feiR::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    pub fn p0_20fei(&self) -> P0_20feiR {
        P0_20feiR::new(((self.bits >> 20) & 1) != 0)
    }
    ...
    pub fn p0_21fei(&self) -> P0_21feiR {
        P0_21feiR::new(((self.bits >> 21) & 1) != 0)
    }
    ...
    pub fn p0_22fei(&self) -> P0_22feiR {
        P0_22feiR::new(((self.bits >> 22) & 1) != 0)
    }
    ...
    pub fn p0_23fei(&self) -> P0_23feiR {
        P0_23feiR::new(((self.bits >> 23) & 1) != 0)
    }
    ...
    pub fn p0_24fei(&self) -> P0_24feiR {
        P0_24feiR::new(((self.bits >> 24) & 1) != 0)
    }
    ...
    pub fn p0_25fei(&self) -> P0_25feiR {
        P0_25feiR::new(((self.bits >> 25) & 1) != 0)
    }
    ...
    pub fn p0_26fei(&self) -> P0_26feiR {
        P0_26feiR::new(((self.bits >> 26) & 1) != 0)
    }
    ...
    pub fn p0_27fei(&self) -> P0_27feiR {
        P0_27feiR::new(((self.bits >> 27) & 1) != 0)
    }
    ...
    pub fn p0_28fei(&self) -> P0_28feiR {
        P0_28feiR::new(((self.bits >> 28) & 1) != 0)
    }
    ...
    pub fn p0_29fei(&self) -> P0_29feiR {
        P0_29feiR::new(((self.bits >> 29) & 1) != 0)
    }
    ...
    pub fn p0_30fei(&self) -> P0_30feiR {
        P0_30feiR::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Status of Falling Edge Interrupt for P0\\[31\\]. 0 = No falling edge detected. 1 = Falling edge interrupt generated."]
    #[inline(always)]
    pub fn p0_31fei(&self) -> P0_31feiR {
        P0_31feiR::new(((self.bits >> 31) & 1) != 0)
    }
}
#[doc = "GPIO Interrupt Status for Falling edge for Port 0.\n\nYou can [`read`](crate::Reg::read) this register and get [`statf0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Statf0Spec;
impl crate::RegisterSpec for Statf0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`statf0::R`](R) reader structure"]
impl crate::Readable for Statf0Spec {}
#[doc = "`reset()` method sets STATF0 to value 0"]
impl crate::Resettable for Statf0Spec {}
