    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disabled_irda_mode_(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::DisabledIrdaMode_)
    }
    #[doc = "Enabled. IrDA mode on UART4 is enabled."]
    #[inline(always)]
    pub fn enabled_irda_mode_o(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::EnabledIrdaModeO)
    }
}
...
pub type IrdainvR = crate::BitReader<Enum>;
impl IrdainvR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
        match self.bits {
            false => Enum::NotInverted_,
            true => Enum::InvertedThisHasN,
        }
    }
    #[doc = "Not inverted."]
    #[inline(always)]
    pub fn is_not_inverted_(&self) -> bool {
        *self == Enum::NotInverted_
    }
    #[doc = "Inverted. This has no effect on the serial output."]
    #[inline(always)]
    pub fn is_inverted_this_has_n(&self) -> bool {
        *self == Enum::InvertedThisHasN
    }
}
#[doc = "Field `IRDAINV` writer - Serial input direction."]
pub type IrdainvW<'a, REG> = crate::BitWriter<'a, REG, Enum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn not_inverted_(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::NotInverted_)
    }
    #[doc = "Inverted. This has no effect on the serial output."]
    #[inline(always)]
    pub fn inverted_this_has_n(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::InvertedThisHasN)
    }
}
...
pub type FixpulseenR = crate::BitReader<Enum>;
impl FixpulseenR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type FixpulseenW<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type PulsedivR = crate::FieldReader<Enum>;
impl PulsedivR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
    ...
    pub fn is_128xtpclk(&self) -> bool {
        *self == Enum::_128xtpclk
    }
    #[doc = "256xTPCLK"]
    #[inline(always)]
    pub fn is_256xtpclk(&self) -> bool {
        *self == Enum::_256xtpclk
    }
}
#[doc = "Field `PULSEDIV` writer - Configures the pulse when FixPulseEn = 1."]
pub type PulsedivW<'a, REG> = crate::FieldWriter<'a, REG, 3, Enum, crate::Safe>;
