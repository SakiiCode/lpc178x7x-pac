...
impl PsR {
    ...
    pub const fn variant(&self) -> Enum {
        match self.bits {
            ...
            2 => Enum::Forced1stickPar,
            3 => Enum::Forced0stickPar,
            _ => unreachable!(),
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn forced1stick_par(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Forced1stickPar)
    }
    #[doc = "Forced 0 stick parity."]
    #[inline(always)]
    pub fn forced0stick_par(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Forced0stickPar)
    }
}
#[doc = "Break Control.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
