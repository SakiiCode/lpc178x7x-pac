...
impl RegisterBlock {
    #[doc = "0x00..0x18 - GPIO PortX Direction control register."]
    #[inline(always)]
    ...
    pub fn dir_iter(&self) -> impl Iterator<Item = &Dir> {
        (0..6).map(move |n| unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(32 * n).cast() })
    }
    #[doc = "0x10..0x28 - Mask register for PortX."]
    #[inline(always)]
    ...
    #[doc = "0x14..0x2c - PortX Pin value register using FIOMASK."]
    #[inline(always)]
    ...
    #[doc = "0x18..0x30 - PortX Output Set register using FIOMASK."]
    #[inline(always)]
    ...
    #[doc = "0x1c..0x34 - PortX Output Clear register using FIOMASK."]
    #[inline(always)]
