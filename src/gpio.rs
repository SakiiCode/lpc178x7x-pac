...
impl RegisterBlock {
    #[doc = "0x00..0x18 - GPIO Port0 Direction control register."]
    #[inline(always)]
    ...
    #[doc = "0x10..0x28 - Mask register for Port0."]
    #[inline(always)]
    ...
    #[doc = "0x14..0x2c - Port0 Pin value register using FIOMASK."]
    #[inline(always)]
    ...
    #[doc = "0x18..0x30 - Port0 Output Set register using FIOMASK."]
    #[inline(always)]
    ...
    #[doc = "0x1c..0x34 - Port0 Output Clear register using FIOMASK."]
    #[inline(always)]
