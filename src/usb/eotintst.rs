...
pub type R = crate::R<EotintstSpec>;
...
pub type Eptxintst0R = crate::BitReader;
...
pub type Eptxintst1R = crate::BitReader;
...
pub type Eptxintst2R = crate::BitReader;
...
pub type Eptxintst3R = crate::BitReader;
...
pub type Eptxintst4R = crate::BitReader;
...
pub type Eptxintst5R = crate::BitReader;
...
pub type Eptxintst6R = crate::BitReader;
...
pub type Eptxintst7R = crate::BitReader;
...
pub type Eptxintst8R = crate::BitReader;
...
pub type Eptxintst9R = crate::BitReader;
...
pub type Eptxintst10R = crate::BitReader;
...
pub type Eptxintst11R = crate::BitReader;
...
pub type Eptxintst12R = crate::BitReader;
...
pub type Eptxintst13R = crate::BitReader;
...
pub type Eptxintst14R = crate::BitReader;
...
pub type Eptxintst15R = crate::BitReader;
...
pub type Eptxintst16R = crate::BitReader;
...
pub type Eptxintst17R = crate::BitReader;
...
pub type Eptxintst18R = crate::BitReader;
...
pub type Eptxintst19R = crate::BitReader;
...
pub type Eptxintst20R = crate::BitReader;
...
pub type Eptxintst21R = crate::BitReader;
...
pub type Eptxintst22R = crate::BitReader;
...
pub type Eptxintst23R = crate::BitReader;
...
pub type Eptxintst24R = crate::BitReader;
...
pub type Eptxintst25R = crate::BitReader;
...
pub type Eptxintst26R = crate::BitReader;
...
pub type Eptxintst27R = crate::BitReader;
...
pub type Eptxintst28R = crate::BitReader;
...
pub type Eptxintst29R = crate::BitReader;
...
pub type Eptxintst30R = crate::BitReader;
...
pub type Eptxintst31R = crate::BitReader;
impl R {
    ...
    pub fn eptxintst1(&self) -> Eptxintst1R {
        Eptxintst1R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    pub fn eptxintst2(&self) -> Eptxintst2R {
        Eptxintst2R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    pub fn eptxintst3(&self) -> Eptxintst3R {
        Eptxintst3R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn eptxintst4(&self) -> Eptxintst4R {
        Eptxintst4R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    pub fn eptxintst5(&self) -> Eptxintst5R {
        Eptxintst5R::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    pub fn eptxintst6(&self) -> Eptxintst6R {
        Eptxintst6R::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    pub fn eptxintst7(&self) -> Eptxintst7R {
        Eptxintst7R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    pub fn eptxintst8(&self) -> Eptxintst8R {
        Eptxintst8R::new(((self.bits >> 8) & 1) != 0)
    }
    ...
    pub fn eptxintst9(&self) -> Eptxintst9R {
        Eptxintst9R::new(((self.bits >> 9) & 1) != 0)
    }
    ...
    pub fn eptxintst10(&self) -> Eptxintst10R {
        Eptxintst10R::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    pub fn eptxintst11(&self) -> Eptxintst11R {
        Eptxintst11R::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    pub fn eptxintst12(&self) -> Eptxintst12R {
        Eptxintst12R::new(((self.bits >> 12) & 1) != 0)
    }
    ...
    pub fn eptxintst13(&self) -> Eptxintst13R {
        Eptxintst13R::new(((self.bits >> 13) & 1) != 0)
    }
    ...
    pub fn eptxintst14(&self) -> Eptxintst14R {
        Eptxintst14R::new(((self.bits >> 14) & 1) != 0)
    }
    ...
    pub fn eptxintst15(&self) -> Eptxintst15R {
        Eptxintst15R::new(((self.bits >> 15) & 1) != 0)
    }
    ...
    pub fn eptxintst16(&self) -> Eptxintst16R {
        Eptxintst16R::new(((self.bits >> 16) & 1) != 0)
    }
    ...
    pub fn eptxintst17(&self) -> Eptxintst17R {
        Eptxintst17R::new(((self.bits >> 17) & 1) != 0)
    }
    ...
    pub fn eptxintst18(&self) -> Eptxintst18R {
        Eptxintst18R::new(((self.bits >> 18) & 1) != 0)
    }
    ...
    pub fn eptxintst19(&self) -> Eptxintst19R {
        Eptxintst19R::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    pub fn eptxintst20(&self) -> Eptxintst20R {
        Eptxintst20R::new(((self.bits >> 20) & 1) != 0)
    }
    ...
    pub fn eptxintst21(&self) -> Eptxintst21R {
        Eptxintst21R::new(((self.bits >> 21) & 1) != 0)
    }
    ...
    pub fn eptxintst22(&self) -> Eptxintst22R {
        Eptxintst22R::new(((self.bits >> 22) & 1) != 0)
    }
    ...
    pub fn eptxintst23(&self) -> Eptxintst23R {
        Eptxintst23R::new(((self.bits >> 23) & 1) != 0)
    }
    ...
    pub fn eptxintst24(&self) -> Eptxintst24R {
        Eptxintst24R::new(((self.bits >> 24) & 1) != 0)
    }
    ...
    pub fn eptxintst25(&self) -> Eptxintst25R {
        Eptxintst25R::new(((self.bits >> 25) & 1) != 0)
    }
    ...
    pub fn eptxintst26(&self) -> Eptxintst26R {
        Eptxintst26R::new(((self.bits >> 26) & 1) != 0)
    }
    ...
    pub fn eptxintst27(&self) -> Eptxintst27R {
        Eptxintst27R::new(((self.bits >> 27) & 1) != 0)
    }
    ...
    pub fn eptxintst28(&self) -> Eptxintst28R {
        Eptxintst28R::new(((self.bits >> 28) & 1) != 0)
    }
    ...
    pub fn eptxintst29(&self) -> Eptxintst29R {
        Eptxintst29R::new(((self.bits >> 29) & 1) != 0)
    }
    ...
    pub fn eptxintst30(&self) -> Eptxintst30R {
        Eptxintst30R::new(((self.bits >> 30) & 1) != 0)
    }
    ...
    pub fn eptxintst31(&self) -> Eptxintst31R {
        Eptxintst31R::new(((self.bits >> 31) & 1) != 0)
    }
}
#[doc = "USB End of Transfer Interrupt Status\n\nYou can [`read`](crate::Reg::read) this register and get [`eotintst::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EotintstSpec;
impl crate::RegisterSpec for EotintstSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eotintst::R`](R) reader structure"]
impl crate::Readable for EotintstSpec {}
#[doc = "`reset()` method sets EOTINTST to value 0"]
impl crate::Resettable for EotintstSpec {}
