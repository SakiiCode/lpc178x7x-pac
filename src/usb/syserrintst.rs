...
pub type R = crate::R<SyserrintstSpec>;
...
pub type Eperrintst0R = crate::BitReader;
...
pub type Eperrintst1R = crate::BitReader;
...
pub type Eperrintst2R = crate::BitReader;
...
pub type Eperrintst3R = crate::BitReader;
...
pub type Eperrintst4R = crate::BitReader;
...
pub type Eperrintst5R = crate::BitReader;
...
pub type Eperrintst6R = crate::BitReader;
...
pub type Eperrintst7R = crate::BitReader;
...
pub type Eperrintst8R = crate::BitReader;
...
pub type Eperrintst9R = crate::BitReader;
...
pub type Eperrintst10R = crate::BitReader;
...
pub type Eperrintst11R = crate::BitReader;
...
pub type Eperrintst12R = crate::BitReader;
...
pub type Eperrintst13R = crate::BitReader;
...
pub type Eperrintst14R = crate::BitReader;
...
pub type Eperrintst15R = crate::BitReader;
...
pub type Eperrintst16R = crate::BitReader;
...
pub type Eperrintst17R = crate::BitReader;
...
pub type Eperrintst18R = crate::BitReader;
...
pub type Eperrintst19R = crate::BitReader;
...
pub type Eperrintst20R = crate::BitReader;
...
pub type Eperrintst21R = crate::BitReader;
...
pub type Eperrintst22R = crate::BitReader;
...
pub type Eperrintst23R = crate::BitReader;
...
pub type Eperrintst24R = crate::BitReader;
...
pub type Eperrintst25R = crate::BitReader;
...
pub type Eperrintst26R = crate::BitReader;
...
pub type Eperrintst27R = crate::BitReader;
...
pub type Eperrintst28R = crate::BitReader;
...
pub type Eperrintst29R = crate::BitReader;
...
pub type Eperrintst30R = crate::BitReader;
...
pub type Eperrintst31R = crate::BitReader;
impl R {
    ...
    pub fn eperrintst0(&self) -> Eperrintst0R {
        Eperrintst0R::new((self.bits & 1) != 0)
    }
    ...
    pub fn eperrintst1(&self) -> Eperrintst1R {
        Eperrintst1R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    pub fn eperrintst2(&self) -> Eperrintst2R {
        Eperrintst2R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    pub fn eperrintst3(&self) -> Eperrintst3R {
        Eperrintst3R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn eperrintst4(&self) -> Eperrintst4R {
        Eperrintst4R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    pub fn eperrintst5(&self) -> Eperrintst5R {
        Eperrintst5R::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    pub fn eperrintst6(&self) -> Eperrintst6R {
        Eperrintst6R::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    pub fn eperrintst7(&self) -> Eperrintst7R {
        Eperrintst7R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    pub fn eperrintst8(&self) -> Eperrintst8R {
        Eperrintst8R::new(((self.bits >> 8) & 1) != 0)
    }
    ...
    pub fn eperrintst9(&self) -> Eperrintst9R {
        Eperrintst9R::new(((self.bits >> 9) & 1) != 0)
    }
    ...
    pub fn eperrintst10(&self) -> Eperrintst10R {
        Eperrintst10R::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    pub fn eperrintst11(&self) -> Eperrintst11R {
        Eperrintst11R::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    pub fn eperrintst12(&self) -> Eperrintst12R {
        Eperrintst12R::new(((self.bits >> 12) & 1) != 0)
    }
    ...
    pub fn eperrintst13(&self) -> Eperrintst13R {
        Eperrintst13R::new(((self.bits >> 13) & 1) != 0)
    }
    ...
    pub fn eperrintst14(&self) -> Eperrintst14R {
        Eperrintst14R::new(((self.bits >> 14) & 1) != 0)
    }
    ...
    pub fn eperrintst15(&self) -> Eperrintst15R {
        Eperrintst15R::new(((self.bits >> 15) & 1) != 0)
    }
    ...
    pub fn eperrintst16(&self) -> Eperrintst16R {
        Eperrintst16R::new(((self.bits >> 16) & 1) != 0)
    }
    ...
    pub fn eperrintst17(&self) -> Eperrintst17R {
        Eperrintst17R::new(((self.bits >> 17) & 1) != 0)
    }
    ...
    pub fn eperrintst18(&self) -> Eperrintst18R {
        Eperrintst18R::new(((self.bits >> 18) & 1) != 0)
    }
    ...
    pub fn eperrintst19(&self) -> Eperrintst19R {
        Eperrintst19R::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    pub fn eperrintst20(&self) -> Eperrintst20R {
        Eperrintst20R::new(((self.bits >> 20) & 1) != 0)
    }
    ...
    pub fn eperrintst21(&self) -> Eperrintst21R {
        Eperrintst21R::new(((self.bits >> 21) & 1) != 0)
    }
    ...
    pub fn eperrintst22(&self) -> Eperrintst22R {
        Eperrintst22R::new(((self.bits >> 22) & 1) != 0)
    }
    ...
    pub fn eperrintst23(&self) -> Eperrintst23R {
        Eperrintst23R::new(((self.bits >> 23) & 1) != 0)
    }
    ...
    pub fn eperrintst24(&self) -> Eperrintst24R {
        Eperrintst24R::new(((self.bits >> 24) & 1) != 0)
    }
    ...
    pub fn eperrintst25(&self) -> Eperrintst25R {
        Eperrintst25R::new(((self.bits >> 25) & 1) != 0)
    }
    ...
    pub fn eperrintst26(&self) -> Eperrintst26R {
        Eperrintst26R::new(((self.bits >> 26) & 1) != 0)
    }
    ...
    pub fn eperrintst27(&self) -> Eperrintst27R {
        Eperrintst27R::new(((self.bits >> 27) & 1) != 0)
    }
    ...
    pub fn eperrintst28(&self) -> Eperrintst28R {
        Eperrintst28R::new(((self.bits >> 28) & 1) != 0)
    }
    ...
    pub fn eperrintst29(&self) -> Eperrintst29R {
        Eperrintst29R::new(((self.bits >> 29) & 1) != 0)
    }
    ...
    pub fn eperrintst30(&self) -> Eperrintst30R {
        Eperrintst30R::new(((self.bits >> 30) & 1) != 0)
    }
    ...
    pub fn eperrintst31(&self) -> Eperrintst31R {
        Eperrintst31R::new(((self.bits >> 31) & 1) != 0)
    }
}
#[doc = "USB System Error Interrupt Status\n\nYou can [`read`](crate::Reg::read) this register and get [`syserrintst::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SyserrintstSpec;
impl crate::RegisterSpec for SyserrintstSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`syserrintst::R`](R) reader structure"]
impl crate::Readable for SyserrintstSpec {}
#[doc = "`reset()` method sets SYSERRINTST to value 0"]
impl crate::Resettable for SyserrintstSpec {}
