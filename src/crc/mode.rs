...
pub type CrcPolyR = crate::FieldReader<Enum>;
impl CrcPolyR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Enum> {
        match self.bits {
            0 => Some(Enum::CrcCcittPolynomial),
            1 => Some(Enum::Crc16Polynomial),
            2 => Some(Enum::Crc32Polynomial),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn crc_ccitt_polynomial(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::CrcCcittPolynomial)
    }
    #[doc = "CRC-16 polynomial"]
    #[inline(always)]
    pub fn crc_16_polynomial(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Crc16Polynomial)
    }
    #[doc = "CRC-32 polynomial"]
    #[inline(always)]
    pub fn crc_32_polynomial(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Crc32Polynomial)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn no_bit_order_reverse(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::NoBitOrderReverse)
    }
    #[doc = "Bit order reverse for CRC_WR_DATA (per byte)"]
    #[inline(always)]
    pub fn bit_order_reverse_fo(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::BitOrderReverseFo)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn no_ones_complement_(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::NoOnesComplement_)
    }
    #[doc = "One's complement for CRC_WR_DATA"]
    #[inline(always)]
    pub fn ones_complement_for(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::OnesComplementFor)
    }
}
...
pub type BitRvsSumR = crate::BitReader<Enum>;
impl BitRvsSumR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type BitRvsSumW<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type CmplSumR = crate::BitReader<Enum>;
impl CmplSumR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type CmplSumW<'a, REG> = crate::BitWriter<'a, REG, Enum>;
