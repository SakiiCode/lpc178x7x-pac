...
#[doc = "Field `LLI` reader - Linked list item. Bits \\[31:2\\] of the address for the next LLI. Address bits \\[1:0\\] are 0."]
pub type LliR = crate::FieldReader<u32>;
#[doc = "Field `LLI` writer - Linked list item. Bits \\[31:2\\] of the address for the next LLI. Address bits \\[1:0\\] are 0."]
...
impl W {
    #[doc = "Bits 2:31 - Linked list item. Bits \\[31:2\\] of the address for the next LLI. Address bits \\[1:0\\] are 0."]
    #[inline(always)]
    pub fn lli(&mut self) -> LliW<'_, LliSpec> {
        LliW::new(self, 2)
    }
}
