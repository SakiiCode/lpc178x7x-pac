...
pub struct RegisterBlock {
    ...
    erstatus: Erstatus,
    ercontrol: Ercontrol,
    ercounters: Ercounters,
    _reserved30: [u8; 0x04],
    erfirststamp: [Erfirststamp; 3],
    _reserved31: [u8; 0x04],
    erlaststamp: [Erlaststamp; 3],
}
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn erstatus(&self) -> &Erstatus {
        &self.erstatus
    }
    ...
    #[inline(always)]
    pub const fn erfirststamp(&self, n: usize) -> &Erfirststamp {
        &self.erfirststamp[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x90..0x9c - Event Monitor/Recorder First Stamp register for channel 0. Retains the time stamp for the first event on channel 0."]
    #[inline(always)]
    pub fn erfirststamp_iter(&self) -> impl Iterator<Item = &Erfirststamp> {
        self.erfirststamp.iter()
    }
...
pub mod ercontrol;
#[doc = "ERSTATUS (rw) register accessor: Event Monitor/Recorder Status register. Contains status flags for event channels and other Event Monitor/Recorder conditions.\n\nYou can [`read`](crate::Reg::read) this register and get [`erstatus::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`erstatus::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@erstatus`] module"]
#[doc(alias = "ERSTATUS")]
pub type Erstatus = crate::Reg<erstatus::ErstatusSpec>;
...
pub mod erstatus;
#[doc = "ERCOUNTERS (r) register accessor: Event Monitor/Recorder Counters register. Allows reading the counters associated with the event channels.\n\nYou can [`read`](crate::Reg::read) this register and get [`ercounters::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ercounters`] module"]
#[doc(alias = "ERCOUNTERS")]
pub type Ercounters = crate::Reg<ercounters::ErcountersSpec>;
#[doc = "Event Monitor/Recorder Counters register. Allows reading the counters associated with the event channels."]
pub mod ercounters;
#[doc = "ERFIRSTSTAMP (r) register accessor: Event Monitor/Recorder First Stamp register for channel 0. Retains the time stamp for the first event on channel 0.\n\nYou can [`read`](crate::Reg::read) this register and get [`erfirststamp::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@erfirststamp`] module"]
#[doc(alias = "ERFIRSTSTAMP")]
pub type Erfirststamp = crate::Reg<erfirststamp::ErfirststampSpec>;
...
#[doc = "ERLASTSTAMP (r) register accessor: Event Monitor/Recorder Last Stamp register for channel 0. Retains the time stamp for the last (i.e. most recent) event on channel 0.\n\nYou can [`read`](crate::Reg::read) this register and get [`erlaststamp::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@erlaststamp`] module"]
#[doc(alias = "ERLASTSTAMP")]
pub type Erlaststamp = crate::Reg<erlaststamp::ErlaststampSpec>;
