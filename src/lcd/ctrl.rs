...
pub type LcdbppR = crate::FieldReader;
...
pub type LcdbppW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type LcdbwR = crate::BitReader;
...
pub type LcdbwW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LcdtftR = crate::BitReader;
...
pub type LcdtftW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BgrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BeboR = crate::BitReader;
...
pub type BeboW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BepoR = crate::BitReader;
...
pub type BepoW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LCDPWR` reader - LCD power enable. 0 = power not gated through to LCD panel and LCD_VD\\[23:0\\] signals disabled, (held LOW). 1 = power gated through to LCD panel and LCD_VD\\[23:0\\] signals enabled, (active). See LCD power-up and power-down sequence for details on LCD power sequencing."]
pub type LcdpwrR = crate::BitReader;
#[doc = "Field `LCDPWR` writer - LCD power enable. 0 = power not gated through to LCD panel and LCD_VD\\[23:0\\] signals disabled, (held LOW). 1 = power gated through to LCD panel and LCD_VD\\[23:0\\] signals enabled, (active). See LCD power-up and power-down sequence for details on LCD power sequencing."]
pub type LcdpwrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LcdvcompR = crate::FieldReader;
...
pub type LcdvcompW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl R {
    ...
    pub fn lcdbpp(&self) -> LcdbppR {
        LcdbppR::new(((self.bits >> 1) & 7) as u8)
    }
    ...
    pub fn bepo(&self) -> BepoR {
        BepoR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - LCD power enable. 0 = power not gated through to LCD panel and LCD_VD\\[23:0\\] signals disabled, (held LOW). 1 = power gated through to LCD panel and LCD_VD\\[23:0\\] signals enabled, (active). See LCD power-up and power-down sequence for details on LCD power sequencing."]
    #[inline(always)]
    pub fn lcdpwr(&self) -> LcdpwrR {
        LcdpwrR::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    pub fn lcdvcomp(&self) -> LcdvcompR {
        LcdvcompR::new(((self.bits >> 12) & 3) as u8)
    }
    ...
    pub fn watermark(&self) -> WatermarkR {
        WatermarkR::new(((self.bits >> 16) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - LCD enable control bit. 0 = LCD disabled. Signals LCD_LP, LCD_DCLK, LCD_FP, LCD_ENAB_M, and LCD_LE are low. 1 = LCD enabled. Signals LCD_LP, LCD_DCLK, LCD_FP, LCD_ENAB_M, and LCD_LE are high. See LCD power-up and power-down sequence for details on LCD power sequencing."]
    #[inline(always)]
    pub fn lcden(&mut self) -> LcdenW<'_, CtrlSpec> {
        LcdenW::new(self, 0)
    }
    #[doc = "Bits 1:3 - LCD bits per pixel. Selects the number of bits per LCD pixel: 000 = 1 bpp. 001 = 2 bpp. 010 = 4 bpp. 011 = 8 bpp. 100 = 16 bpp. 101 = 24 bpp (TFT panel only). 110 = 16 bpp, 5:6:5 mode. 111 = 12 bpp, 4:4:4 mode."]
    #[inline(always)]
    pub fn lcdbpp(&mut self) -> LcdbppW<'_, CtrlSpec> {
        LcdbppW::new(self, 1)
    }
    #[doc = "Bit 4 - STN LCD monochrome/color selection. 0 = STN LCD is color. 1 = STN LCD is monochrome. This bit has no meaning in TFT mode."]
    #[inline(always)]
    pub fn lcdbw(&mut self) -> LcdbwW<'_, CtrlSpec> {
        LcdbwW::new(self, 4)
    }
    #[doc = "Bit 5 - LCD panel TFT type selection. 0 = LCD is an STN display. Use gray scaler. 1 = LCD is a TFT display. Do not use gray scaler."]
    #[inline(always)]
    pub fn lcdtft(&mut self) -> LcdtftW<'_, CtrlSpec> {
        LcdtftW::new(self, 5)
    }
    #[doc = "Bit 6 - Monochrome LCD interface width. Controls whether a monochrome STN LCD uses a 4 or 8-bit parallel interface. It has no meaning in other modes and must be programmed to zero. 0 = monochrome LCD uses a 4-bit interface. 1 = monochrome LCD uses a 8-bit interface."]
    #[inline(always)]
    pub fn lcdmono8(&mut self) -> Lcdmono8W<'_, CtrlSpec> {
        Lcdmono8W::new(self, 6)
    }
    #[doc = "Bit 7 - Single or Dual LCD panel selection. STN LCD interface is: 0 = single-panel. 1 = dual-panel."]
    #[inline(always)]
    pub fn lcddual(&mut self) -> LcddualW<'_, CtrlSpec> {
        LcddualW::new(self, 7)
    }
    #[doc = "Bit 8 - Color format selection. 0 = RGB: normal output. 1 = BGR: red and blue swapped."]
    #[inline(always)]
    pub fn bgr(&mut self) -> BgrW<'_, CtrlSpec> {
        BgrW::new(self, 8)
    }
    #[doc = "Bit 9 - Big-endian Byte Order. Controls byte ordering in memory: 0 = little-endian byte order. 1 = big-endian byte order."]
    #[inline(always)]
    pub fn bebo(&mut self) -> BeboW<'_, CtrlSpec> {
        BeboW::new(self, 9)
    }
    #[doc = "Bit 10 - Big-Endian Pixel Ordering. Controls pixel ordering within a byte: 0 = little-endian ordering within a byte. 1 = big-endian pixel ordering within a byte. The BEPO bit selects between little and big-endian pixel packing for 1, 2, and 4 bpp display modes, it has no effect on 8 or 16 bpp pixel formats. See Pixel serializer for more information on the data format."]
    #[inline(always)]
    pub fn bepo(&mut self) -> BepoW<'_, CtrlSpec> {
        BepoW::new(self, 10)
    }
    #[doc = "Bit 11 - LCD power enable. 0 = power not gated through to LCD panel and LCD_VD\\[23:0\\] signals disabled, (held LOW). 1 = power gated through to LCD panel and LCD_VD\\[23:0\\] signals enabled, (active). See LCD power-up and power-down sequence for details on LCD power sequencing."]
    #[inline(always)]
    pub fn lcdpwr(&mut self) -> LcdpwrW<'_, CtrlSpec> {
        LcdpwrW::new(self, 11)
    }
    #[doc = "Bits 12:13 - LCD Vertical Compare Interrupt. Generate VComp interrupt at: 00 = start of vertical synchronization. 01 = start of back porch. 10 = start of active video. 11 = start of front porch."]
    #[inline(always)]
    pub fn lcdvcomp(&mut self) -> LcdvcompW<'_, CtrlSpec> {
        LcdvcompW::new(self, 12)
    }
    #[doc = "Bit 16 - LCD DMA FIFO watermark level. Controls when DMA requests are generated: 0 = An LCD DMA request is generated when either of the DMA FIFOs have four or more empty locations. 1 = An LCD DMA request is generated when either of the DMA FIFOs have eight or more empty locations."]
    #[inline(always)]
    pub fn watermark(&mut self) -> WatermarkW<'_, CtrlSpec> {
        WatermarkW::new(self, 16)
    }
}
