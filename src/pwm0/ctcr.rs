...
pub type ModR = crate::FieldReader<Enum>;
impl ModR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
        match self.bits {
            0 => Enum::TimerModeTheTcI,
            1 => Enum::RisingEdgeCounter_,
            2 => Enum::FallingEdgeCounter,
            3 => Enum::DualEdgeCounterMo,
            _ => unreachable!(),
        }
    }
    ...
    pub fn is_dual_edge_counter_mo(&self) -> bool {
        *self == Enum::DualEdgeCounterMo
    }
}
#[doc = "Field `MOD` writer - Counter/ Timer Mode"]
pub type ModW<'a, REG> = crate::FieldWriter<'a, REG, 2, Enum, crate::Safe>;
...
pub type CisR = crate::FieldReader<Enum>;
impl CisR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Enum> {
        match self.bits {
            0 => Some(Enum::ForPwm0_00EqPwm0_),
            _ => None,
        }
    }
...
pub type CisW<'a, REG> = crate::FieldWriter<'a, REG, 2, Enum>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn for_pwm0_00_eq_pwm0_(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::ForPwm0_00EqPwm0_)
    }
}
impl R {
