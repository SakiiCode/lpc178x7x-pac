...
impl W {
    ...
    #[inline(always)]
    pub fn rxoverrunintset(&mut self) -> RxoverrunintsetW<'_, IntsetSpec> {
    ...
    #[inline(always)]
    pub fn rxerrorintset(&mut self) -> RxerrorintsetW<'_, IntsetSpec> {
    ...
    #[inline(always)]
    pub fn rxfinishedintset(&mut self) -> RxfinishedintsetW<'_, IntsetSpec> {
    ...
    #[inline(always)]
    pub fn rxdoneintset(&mut self) -> RxdoneintsetW<'_, IntsetSpec> {
    ...
    #[inline(always)]
    pub fn txunderrunintset(&mut self) -> TxunderrunintsetW<'_, IntsetSpec> {
    ...
    #[inline(always)]
    pub fn txerrorintset(&mut self) -> TxerrorintsetW<'_, IntsetSpec> {
    ...
    #[inline(always)]
    pub fn txfinishedintset(&mut self) -> TxfinishedintsetW<'_, IntsetSpec> {
    ...
    #[inline(always)]
    pub fn txdoneintset(&mut self) -> TxdoneintsetW<'_, IntsetSpec> {
    ...
    #[inline(always)]
    pub fn softintset(&mut self) -> SoftintsetW<'_, IntsetSpec> {
    ...
    #[inline(always)]
    pub fn wakeupintset(&mut self) -> WakeupintsetW<'_, IntsetSpec> {
