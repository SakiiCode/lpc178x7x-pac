...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn dynamiccontrol(&self) -> &Dynamiccontrol {
        &self.dynamiccontrol
    }
    #[doc = "0x24 - Configures dynamic memory refresh."]
    #[inline(always)]
    pub const fn dynamicrefresh(&self) -> &Dynamicrefresh {
        &self.dynamicrefresh
    }
    #[doc = "0x28 - Configures dynamic memory read strategy."]
    #[inline(always)]
    pub const fn dynamicreadconfig(&self) -> &Dynamicreadconfig {
        &self.dynamicreadconfig
    }
    #[doc = "0x30 - Precharge command period."]
    #[inline(always)]
    pub const fn dynamicrp(&self) -> &Dynamicrp {
        &self.dynamicrp
    }
    #[doc = "0x34 - Active to precharge command period."]
    #[inline(always)]
    pub const fn dynamicras(&self) -> &Dynamicras {
        &self.dynamicras
    }
    #[doc = "0x38 - Self-refresh exit time."]
    #[inline(always)]
    pub const fn dynamicsrex(&self) -> &Dynamicsrex {
        &self.dynamicsrex
    }
    #[doc = "0x3c - Last-data-out to active command time."]
    #[inline(always)]
    pub const fn dynamicapr(&self) -> &Dynamicapr {
        &self.dynamicapr
    }
    #[doc = "0x40 - Data-in to active command time."]
    #[inline(always)]
    pub const fn dynamicdal(&self) -> &Dynamicdal {
        &self.dynamicdal
    }
    #[doc = "0x44 - Write recovery time."]
    #[inline(always)]
    pub const fn dynamicwr(&self) -> &Dynamicwr {
        &self.dynamicwr
    }
    #[doc = "0x48 - Selects the active to active command period."]
    #[inline(always)]
    pub const fn dynamicrc(&self) -> &Dynamicrc {
        &self.dynamicrc
    }
    #[doc = "0x4c - Selects the auto-refresh period."]
    #[inline(always)]
    pub const fn dynamicrfc(&self) -> &Dynamicrfc {
        &self.dynamicrfc
    }
    #[doc = "0x50 - Time for exit self-refresh to active command."]
    #[inline(always)]
    pub const fn dynamicxsr(&self) -> &Dynamicxsr {
        &self.dynamicxsr
    }
    #[doc = "0x54 - Latency for active bank A to active bank B."]
    #[inline(always)]
    pub const fn dynamicrrd(&self) -> &Dynamicrrd {
        &self.dynamicrrd
    }
    #[doc = "0x58 - Time for load mode register to active command."]
    #[inline(always)]
    pub const fn dynamicmrd(&self) -> &Dynamicmrd {
        &self.dynamicmrd
    }
    #[doc = "0x80 - Time for long static memory read and write transfers."]
    #[inline(always)]
    pub const fn staticextendedwait(&self) -> &Staticextendedwait {
        &self.staticextendedwait
    }
    #[doc = "0x100..0x110 - Configuration information for EMC_DYCS0."]
    #[inline(always)]
    pub const fn dynamicconfig(&self, n: usize) -> &Dynamicconfig {
    ...
    #[doc = "0x100..0x110 - Configuration information for EMC_DYCS0."]
    #[inline(always)]
    pub fn dynamicconfig_iter(&self) -> impl Iterator<Item = &Dynamicconfig> {
    ...
    #[doc = "0x104..0x114 - RAS and CAS latencies for EMC_DYCS0."]
    #[inline(always)]
    pub const fn dynamicrascas(&self, n: usize) -> &Dynamicrascas {
        #[allow(clippy::no_effect)]
        [(); 4][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x104..0x114 - RAS and CAS latencies for EMC_DYCS0."]
    #[inline(always)]
    pub fn dynamicrascas_iter(&self) -> impl Iterator<Item = &Dynamicrascas> {
        (0..4).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(260)
    ...
    #[doc = "0x200..0x210 - Configuration for EMC_CS0."]
    #[inline(always)]
    pub const fn staticconfig(&self, n: usize) -> &Staticconfig {
        #[allow(clippy::no_effect)]
        [(); 4][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x200..0x210 - Configuration for EMC_CS0."]
    #[inline(always)]
    pub fn staticconfig_iter(&self) -> impl Iterator<Item = &Staticconfig> {
        (0..4).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(512)
    ...
    #[doc = "0x204..0x214 - Delay from EMC_CS0 to write enable."]
    #[inline(always)]
    pub const fn staticwaitwen(&self, n: usize) -> &Staticwaitwen {
        #[allow(clippy::no_effect)]
        [(); 4][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x204..0x214 - Delay from EMC_CS0 to write enable."]
    #[inline(always)]
    pub fn staticwaitwen_iter(&self) -> impl Iterator<Item = &Staticwaitwen> {
        (0..4).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(516)
    ...
    #[doc = "0x208..0x218 - Delay from EMC_CS0 or address change, whichever is later, to output enable."]
    #[inline(always)]
    pub const fn staticwaitoen(&self, n: usize) -> &Staticwaitoen {
        #[allow(clippy::no_effect)]
        [(); 4][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x208..0x218 - Delay from EMC_CS0 or address change, whichever is later, to output enable."]
    #[inline(always)]
    pub fn staticwaitoen_iter(&self) -> impl Iterator<Item = &Staticwaitoen> {
        (0..4).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(520)
    ...
    #[doc = "0x20c..0x21c - Delay from EMC_CS0 to a read access."]
    #[inline(always)]
    pub const fn staticwaitrd(&self, n: usize) -> &Staticwaitrd {
        #[allow(clippy::no_effect)]
        [(); 4][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x20c..0x21c - Delay from EMC_CS0 to a read access."]
    #[inline(always)]
    pub fn staticwaitrd_iter(&self) -> impl Iterator<Item = &Staticwaitrd> {
        (0..4).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(524)
    ...
    #[doc = "0x210..0x220 - Delay for asynchronous page mode sequential accesses for EMC_CS0."]
    #[inline(always)]
    pub const fn staticwaitpage(&self, n: usize) -> &Staticwaitpage {
        #[allow(clippy::no_effect)]
        [(); 4][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x210..0x220 - Delay for asynchronous page mode sequential accesses for EMC_CS0."]
    #[inline(always)]
    pub fn staticwaitpage_iter(&self) -> impl Iterator<Item = &Staticwaitpage> {
        (0..4).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(528)
    ...
    #[doc = "0x214..0x224 - Delay from EMC_CS0 to a write access."]
    #[inline(always)]
    pub const fn staticwaitwr(&self, n: usize) -> &Staticwaitwr {
        #[allow(clippy::no_effect)]
        [(); 4][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x214..0x224 - Delay from EMC_CS0 to a write access."]
    #[inline(always)]
    pub fn staticwaitwr_iter(&self) -> impl Iterator<Item = &Staticwaitwr> {
        (0..4).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(532)
    ...
    #[doc = "0x218..0x228 - Number of bus turnaround cycles EMC_CS0."]
    #[inline(always)]
    pub const fn staticwaitturn(&self, n: usize) -> &Staticwaitturn {
        #[allow(clippy::no_effect)]
        [(); 4][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x218..0x228 - Number of bus turnaround cycles EMC_CS0."]
    #[inline(always)]
    pub fn staticwaitturn_iter(&self) -> impl Iterator<Item = &Staticwaitturn> {
        (0..4).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(536)
