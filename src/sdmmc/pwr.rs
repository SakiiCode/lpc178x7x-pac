...
impl R {
    ...
    pub fn ctrl(&self) -> CtrlR {
        CtrlR::new((self.bits & 3) as u8)
    }
    #[doc = "Bit 6 - SD_CMD output control."]
    #[inline(always)]
    pub fn opendrain(&self) -> OpendrainR {
        OpendrainR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Rod control."]
    #[inline(always)]
    pub fn rod(&self) -> RodR {
        RodR::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - Power control"]
    #[inline(always)]
    pub fn ctrl(&mut self) -> CtrlW<'_, PwrSpec> {
        CtrlW::new(self, 0)
    }
    #[doc = "Bit 6 - SD_CMD output control."]
    #[inline(always)]
    pub fn opendrain(&mut self) -> OpendrainW<'_, PwrSpec> {
        OpendrainW::new(self, 6)
    }
    #[doc = "Bit 7 - Rod control."]
    #[inline(always)]
    pub fn rod(&mut self) -> RodW<'_, PwrSpec> {
        RodW::new(self, 7)
    }
}
