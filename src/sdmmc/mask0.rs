...
impl R {
    ...
    #[inline(always)]
    pub fn mask12(&self) -> Mask12R {
        Mask12R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Mask RxActive flag."]
    #[inline(always)]
    pub fn mask13(&self) -> Mask13R {
        Mask13R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Mask TxFifoHalfEmpty flag."]
    #[inline(always)]
    pub fn mask14(&self) -> Mask14R {
        Mask14R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Mask RxFifoHalfFull flag."]
    #[inline(always)]
    pub fn mask15(&self) -> Mask15R {
        Mask15R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - Mask TxFifoFull flag."]
    #[inline(always)]
    pub fn mask16(&self) -> Mask16R {
        Mask16R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Mask RxFifoFull flag."]
    #[inline(always)]
    pub fn mask17(&self) -> Mask17R {
        Mask17R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - Mask TxFifoEmpty flag."]
    #[inline(always)]
    pub fn mask18(&self) -> Mask18R {
        Mask18R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - Mask RxFifoEmpty flag."]
    #[inline(always)]
    pub fn mask19(&self) -> Mask19R {
        Mask19R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - Mask TxDataAvlbl flag."]
    #[inline(always)]
    pub fn mask20(&self) -> Mask20R {
        Mask20R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Mask RxDataAvlbl flag."]
    #[inline(always)]
    pub fn mask21(&self) -> Mask21R {
        Mask21R::new(((self.bits >> 21) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Mask CmdCrcFail flag."]
    #[inline(always)]
    pub fn mask0(&mut self) -> Mask0W<'_, Mask0Spec> {
        Mask0W::new(self, 0)
    }
    #[doc = "Bit 1 - Mask DataCrcFail flag."]
    #[inline(always)]
    pub fn mask1(&mut self) -> Mask1W<'_, Mask0Spec> {
        Mask1W::new(self, 1)
    }
    #[doc = "Bit 2 - Mask CmdTimeOut flag."]
    #[inline(always)]
    pub fn mask2(&mut self) -> Mask2W<'_, Mask0Spec> {
        Mask2W::new(self, 2)
    }
    #[doc = "Bit 3 - Mask DataTimeOut flag."]
    #[inline(always)]
    pub fn mask3(&mut self) -> Mask3W<'_, Mask0Spec> {
        Mask3W::new(self, 3)
    }
    #[doc = "Bit 4 - Mask TxUnderrun flag."]
    #[inline(always)]
    pub fn mask4(&mut self) -> Mask4W<'_, Mask0Spec> {
        Mask4W::new(self, 4)
    }
    #[doc = "Bit 5 - Mask RxOverrun flag."]
    #[inline(always)]
    pub fn mask5(&mut self) -> Mask5W<'_, Mask0Spec> {
        Mask5W::new(self, 5)
    }
    #[doc = "Bit 6 - Mask CmdRespEnd flag."]
    #[inline(always)]
    pub fn mask6(&mut self) -> Mask6W<'_, Mask0Spec> {
        Mask6W::new(self, 6)
    }
    #[doc = "Bit 7 - Mask CmdSent flag."]
    #[inline(always)]
    pub fn mask7(&mut self) -> Mask7W<'_, Mask0Spec> {
        Mask7W::new(self, 7)
    }
    #[doc = "Bit 8 - Mask DataEnd flag."]
    #[inline(always)]
    pub fn mask8(&mut self) -> Mask8W<'_, Mask0Spec> {
        Mask8W::new(self, 8)
    }
    #[doc = "Bit 9 - Mask StartBitErr flag."]
    #[inline(always)]
    pub fn mask9(&mut self) -> Mask9W<'_, Mask0Spec> {
        Mask9W::new(self, 9)
    }
    #[doc = "Bit 10 - Mask DataBlockEnd flag."]
    #[inline(always)]
    pub fn mask10(&mut self) -> Mask10W<'_, Mask0Spec> {
        Mask10W::new(self, 10)
    }
    #[doc = "Bit 11 - Mask CmdActive flag."]
    #[inline(always)]
    pub fn mask11(&mut self) -> Mask11W<'_, Mask0Spec> {
        Mask11W::new(self, 11)
    }
    #[doc = "Bit 12 - Mask TxActive flag."]
    #[inline(always)]
    pub fn mask12(&mut self) -> Mask12W<'_, Mask0Spec> {
        Mask12W::new(self, 12)
    }
    #[doc = "Bit 13 - Mask RxActive flag."]
    #[inline(always)]
    pub fn mask13(&mut self) -> Mask13W<'_, Mask0Spec> {
        Mask13W::new(self, 13)
    }
    #[doc = "Bit 14 - Mask TxFifoHalfEmpty flag."]
    #[inline(always)]
    pub fn mask14(&mut self) -> Mask14W<'_, Mask0Spec> {
        Mask14W::new(self, 14)
    }
    #[doc = "Bit 15 - Mask RxFifoHalfFull flag."]
    #[inline(always)]
    pub fn mask15(&mut self) -> Mask15W<'_, Mask0Spec> {
        Mask15W::new(self, 15)
    }
    #[doc = "Bit 16 - Mask TxFifoFull flag."]
    #[inline(always)]
    pub fn mask16(&mut self) -> Mask16W<'_, Mask0Spec> {
        Mask16W::new(self, 16)
    }
    #[doc = "Bit 17 - Mask RxFifoFull flag."]
    #[inline(always)]
    pub fn mask17(&mut self) -> Mask17W<'_, Mask0Spec> {
        Mask17W::new(self, 17)
    }
    #[doc = "Bit 18 - Mask TxFifoEmpty flag."]
    #[inline(always)]
    pub fn mask18(&mut self) -> Mask18W<'_, Mask0Spec> {
        Mask18W::new(self, 18)
    }
    #[doc = "Bit 19 - Mask RxFifoEmpty flag."]
    #[inline(always)]
    pub fn mask19(&mut self) -> Mask19W<'_, Mask0Spec> {
        Mask19W::new(self, 19)
    }
    #[doc = "Bit 20 - Mask TxDataAvlbl flag."]
    #[inline(always)]
    pub fn mask20(&mut self) -> Mask20W<'_, Mask0Spec> {
        Mask20W::new(self, 20)
    }
    #[doc = "Bit 21 - Mask RxDataAvlbl flag."]
    #[inline(always)]
    pub fn mask21(&mut self) -> Mask21W<'_, Mask0Spec> {
        Mask21W::new(self, 21)
    }
}
