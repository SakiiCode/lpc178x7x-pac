...
pub type CmdcrcfailR = crate::BitReader;
#[doc = "Field `DATACRCFAIL` reader - Data block sent/received (CRC check failed)."]
pub type DatacrcfailR = crate::BitReader;
...
pub type CmdrespendR = crate::BitReader;
...
pub type TxfifohalfemptyR = crate::BitReader;
#[doc = "Field `RXFIFOHALFFULL` reader - Receive FIFO half full."]
pub type RxfifohalffullR = crate::BitReader;
...
pub type TxdataavlblR = crate::BitReader;
#[doc = "Field `RXDATAAVLBL` reader - Data available in receive FIFO."]
pub type RxdataavlblR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Command response received (CRC check failed)."]
    #[inline(always)]
    pub fn cmdcrcfail(&self) -> CmdcrcfailR {
        CmdcrcfailR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Data block sent/received (CRC check failed)."]
    #[inline(always)]
    pub fn datacrcfail(&self) -> DatacrcfailR {
        DatacrcfailR::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn datatimeout(&self) -> DatatimeoutR {
        DatatimeoutR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn rxoverrun(&self) -> RxoverrunR {
        RxoverrunR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Command response received (CRC check passed)."]
    #[inline(always)]
    pub fn cmdrespend(&self) -> CmdrespendR {
        CmdrespendR::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn startbiterr(&self) -> StartbiterrR {
        StartbiterrR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Data block sent/received (CRC check passed)."]
    #[inline(always)]
    pub fn datablockend(&self) -> DatablockendR {
        DatablockendR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Command transfer in progress."]
    #[inline(always)]
    pub fn cmdactive(&self) -> CmdactiveR {
        CmdactiveR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - Data transmit in progress."]
    #[inline(always)]
    pub fn txactive(&self) -> TxactiveR {
        TxactiveR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Data receive in progress."]
    #[inline(always)]
    pub fn rxactive(&self) -> RxactiveR {
        RxactiveR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Transmit FIFO half empty."]
    #[inline(always)]
    pub fn txfifohalfempty(&self) -> TxfifohalfemptyR {
        TxfifohalfemptyR::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Receive FIFO half full."]
    #[inline(always)]
    pub fn rxfifohalffull(&self) -> RxfifohalffullR {
        RxfifohalffullR::new(((self.bits >> 15) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn txfifoempty(&self) -> TxfifoemptyR {
        TxfifoemptyR::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - Receive FIFO empty."]
    #[inline(always)]
    pub fn rxfifoempty(&self) -> RxfifoemptyR {
        RxfifoemptyR::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - Data available in transmit FIFO."]
    #[inline(always)]
    pub fn txdataavlbl(&self) -> TxdataavlblR {
        TxdataavlblR::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Data available in receive FIFO."]
    #[inline(always)]
    pub fn rxdataavlbl(&self) -> RxdataavlblR {
        RxdataavlblR::new(((self.bits >> 21) & 1) != 0)
    }
}
