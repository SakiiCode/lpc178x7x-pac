...
pub type R = crate::R<P0_31Spec>;
#[doc = "Register `P0_31` writer"]
pub type W = crate::W<P0_31Spec>;
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[31\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P0_31Spec> {
        FuncW::new(self, 0)
    }
}
#[doc = "I/O configuration register for pin P0\\[31\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p0_31::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p0_31::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P0_31Spec;
impl crate::RegisterSpec for P0_31Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p0_31::R`](R) reader structure"]
impl crate::Readable for P0_31Spec {}
#[doc = "`write(|w| ..)` method takes [`p0_31::W`](W) writer structure"]
impl crate::Writable for P0_31Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P0_31 to value 0"]
impl crate::Resettable for P0_31Spec {}
