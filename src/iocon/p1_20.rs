...
pub type R = crate::R<P1_20Spec>;
#[doc = "Register `P1_20` writer"]
pub type W = crate::W<P1_20Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_20(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P1_20)
    }
    #[doc = "D+ transmit data for USB port 1 (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_tx_dp1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbTxDp1)
    }
    #[doc = "Pulse Width Modulator 1, channel 2 output."]
    #[inline(always)]
    pub fn pwm1_2(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Pwm1_2)
    }
    #[doc = "Quadrature Encoder Interface PHA input."]
    #[inline(always)]
    pub fn qei_pha(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::QeiPha)
    }
    #[doc = "Motor control PWM channel 0 feedback input."]
    #[inline(always)]
    pub fn mc_fb0(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::McFb0)
    }
    #[doc = "Serial clock for SSP0."]
    #[inline(always)]
    pub fn ssp0_sck(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Ssp0Sck)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_6(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::LcdVd6)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_10(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::LcdVd10)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[20\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_20Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_20Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_20Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_20Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_20Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_20Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[20\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_20::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_20::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_20Spec;
impl crate::RegisterSpec for P1_20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_20::R`](R) reader structure"]
impl crate::Readable for P1_20Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_20::W`](W) writer structure"]
impl crate::Writable for P1_20Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_20 to value 0x30"]
impl crate::Resettable for P1_20Spec {
