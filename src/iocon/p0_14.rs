...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Enum> {
        match self.bits {
            0 => Some(Enum::P0_14),
            1 => Some(Enum::UsbHsten2),
            2 => Some(Enum::Ssp1Ssel),
            3 => Some(Enum::UsbConnect2),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn p0_14(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P0_14)
    }
    #[doc = "Host Enabled status for USB port 2."]
    #[inline(always)]
    pub fn usb_hsten2(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbHsten2)
    }
    #[doc = "Slave Select for SSP1."]
    #[inline(always)]
