...
pub type R = crate::R<P1_21Spec>;
#[doc = "Register `P1_21` writer"]
pub type W = crate::W<P1_21Spec>;
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Enum> {
        match self.bits {
            0 => Some(Enum::P1_21),
            1 => Some(Enum::UsbTxDm1),
            2 => Some(Enum::Pwm1_3),
            3 => Some(Enum::Ssp0Ssel),
            4 => Some(Enum::McAbort),
            6 => Some(Enum::LcdVd7),
            7 => Some(Enum::LcdVd11),
            _ => None,
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_21(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P1_21)
    }
    #[doc = "D- transmit data for USB port 1 (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_tx_dm1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbTxDm1)
    }
    #[doc = "Pulse Width Modulator 1, channel 3 output."]
    #[inline(always)]
    pub fn pwm1_3(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Pwm1_3)
    }
    #[doc = "Slave Select for SSP0."]
    #[inline(always)]
    pub fn ssp0_ssel(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Ssp0Ssel)
    }
    #[doc = "Motor control PWM, active low fast abort."]
    #[inline(always)]
    pub fn mc_abort(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::McAbort)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_7(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::LcdVd7)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_11(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::LcdVd11)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[21\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_21Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_21Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_21Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_21Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_21Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_21Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[21\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_21::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_21::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_21Spec;
impl crate::RegisterSpec for P1_21Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_21::R`](R) reader structure"]
impl crate::Readable for P1_21Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_21::W`](W) writer structure"]
impl crate::Writable for P1_21Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_21 to value 0x30"]
impl crate::Resettable for P1_21Spec {
