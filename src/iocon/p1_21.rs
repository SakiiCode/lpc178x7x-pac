...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            0 => Some(Func::P1_21),
            1 => Some(Func::UsbTxDm1),
            2 => Some(Func::Pwm1_3),
            3 => Some(Func::Ssp0Ssel),
            4 => Some(Func::McAbort),
            6 => Some(Func::LcdVd7),
            7 => Some(Func::LcdVd11),
            _ => None,
