...
pub type R = crate::R<P1_28Spec>;
#[doc = "Register `P1_28` writer"]
pub type W = crate::W<P1_28Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_28(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P1_28)
    }
    #[doc = "USB port 1 I2C serial clock (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_scl1(self) -> &'a mut crate::W<REG> {
        self.variant(Func::UsbScl1)
    }
    #[doc = "Capture input for PWM1, channel 0."]
    #[inline(always)]
    pub fn pwm1_cap0(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Pwm1Cap0)
    }
    #[doc = "Match output for Timer 0, channel 0."]
    #[inline(always)]
    pub fn t0_mat0(self) -> &'a mut crate::W<REG> {
        self.variant(Func::T0Mat0)
    }
    #[doc = "Motor control PWM channel 2, output A."]
    #[inline(always)]
    pub fn mc_2a(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Mc2a)
    }
    #[doc = "Slave Select for SSP0."]
    #[inline(always)]
    ...
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_22(self) -> &'a mut crate::W<REG> {
        self.variant(Func::LcdVd22)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[28\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_28Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_28Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_28Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_28Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_28Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_28Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[28\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_28::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_28::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_28Spec;
impl crate::RegisterSpec for P1_28Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_28::R`](R) reader structure"]
impl crate::Readable for P1_28Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_28::W`](W) writer structure"]
impl crate::Writable for P1_28Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_28 to value 0x30"]
impl crate::Resettable for P1_28Spec {
