...
pub type R = crate::R<P1_0Spec>;
#[doc = "Register `P1_0` writer"]
pub type W = crate::W<P1_0Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_0(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P1_0)
    }
    #[doc = "Ethernet transmit data 0 (RMII/MII interface)."]
    #[inline(always)]
    pub fn enet_txd0(self) -> &'a mut crate::W<REG> {
        self.variant(Func::EnetTxd0)
    }
    #[doc = "Capture input for Timer 3, channel 1."]
    #[inline(always)]
    ...
    #[doc = "Serial clock for SSP2."]
    #[inline(always)]
    pub fn ssp2_sck(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Ssp2Sck)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[0\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_0Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_0Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_0Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_0Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_0Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_0Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[0\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_0Spec;
impl crate::RegisterSpec for P1_0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_0::R`](R) reader structure"]
impl crate::Readable for P1_0Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_0::W`](W) writer structure"]
impl crate::Writable for P1_0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_0 to value 0x30"]
impl crate::Resettable for P1_0Spec {
