...
pub type R = crate::R<P2_20Spec>;
#[doc = "Register `P2_20` writer"]
pub type W = crate::W<P2_20Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p2_20(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P2_20)
    }
    #[doc = "SDRAM chip select 0."]
    #[inline(always)]
    pub fn emc_dycs0(self) -> &'a mut crate::W<REG> {
        self.variant(Func::EmcDycs0)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[20\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P2_20Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P2_20Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P2_20Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P2_20Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P2_20Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P2_20Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P2\\[20\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p2_20::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p2_20::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P2_20Spec;
impl crate::RegisterSpec for P2_20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p2_20::R`](R) reader structure"]
impl crate::Readable for P2_20Spec {}
#[doc = "`write(|w| ..)` method takes [`p2_20::W`](W) writer structure"]
impl crate::Writable for P2_20Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P2_20 to value 0x30"]
impl crate::Resettable for P2_20Spec {
