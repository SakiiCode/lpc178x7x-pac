...
pub type R = crate::R<P2_13Spec>;
#[doc = "Register `P2_13` writer"]
pub type W = crate::W<P2_13Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin. This pin includes a 5 ns input glitch filter."]
    #[inline(always)]
    pub fn p2_13(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P2_13)
    }
    #[doc = "External interrupt 3 input."]
    #[inline(always)]
    pub fn eint3(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Eint3)
    }
    #[doc = "Data line 3 for SD card interface."]
    #[inline(always)]
    ...
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_19(self) -> &'a mut crate::W<REG> {
        self.variant(Func::LcdVd19)
    }
}
impl R {
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[13\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P2_13Spec> {
        FuncW::new(self, 0)
    }
}
#[doc = "I/O configuration register for pin P2\\[13\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p2_13::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p2_13::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P2_13Spec;
impl crate::RegisterSpec for P2_13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p2_13::R`](R) reader structure"]
impl crate::Readable for P2_13Spec {}
#[doc = "`write(|w| ..)` method takes [`p2_13::W`](W) writer structure"]
impl crate::Writable for P2_13Spec {
