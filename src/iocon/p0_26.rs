...
pub type DacenR = crate::BitReader<Enum>;
impl DacenR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type DacenW<'a, REG> = crate::BitWriter<'a, REG, Enum>;
