...
pub type R = crate::R<P1_12Spec>;
#[doc = "Register `P1_12` writer"]
pub type W = crate::W<P1_12Spec>;
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            0 => Some(Func::P1_12),
            1 => Some(Func::EnetRxd3),
            2 => Some(Func::SdDat3),
            3 => Some(Func::Pwm0Cap0),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_12(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P1_12)
    }
    #[doc = "Ethernet Receive Data (MII interface)."]
    #[inline(always)]
    pub fn enet_rxd3(self) -> &'a mut crate::W<REG> {
        self.variant(Func::EnetRxd3)
    }
    #[doc = "Data line 3 for SD card interface."]
    #[inline(always)]
    pub fn sd_dat_3(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SdDat3)
    }
    #[doc = "Capture input for PWM0, channel 0."]
    #[inline(always)]
    pub fn pwm0_cap0(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Pwm0Cap0)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[12\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_12Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_12Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_12Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_12Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_12Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_12Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[12\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_12Spec;
impl crate::RegisterSpec for P1_12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_12::R`](R) reader structure"]
impl crate::Readable for P1_12Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_12::W`](W) writer structure"]
impl crate::Writable for P1_12Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_12 to value 0x30"]
impl crate::Resettable for P1_12Spec {
