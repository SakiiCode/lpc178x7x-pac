...
pub type R = crate::R<P1_26Spec>;
#[doc = "Register `P1_26` writer"]
pub type W = crate::W<P1_26Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_26(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P1_26)
    }
    #[doc = "USB port 1 Bus Suspend status (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_sspnd1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbSspnd1)
    }
    #[doc = "Pulse Width Modulator 1, channel 6 output."]
    #[inline(always)]
    pub fn pwm1_6(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Pwm1_6)
    }
    #[doc = "Capture input for Timer 0, channel 0."]
    #[inline(always)]
    pub fn t0_cap0(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::T0Cap0)
    }
    #[doc = "Motor control PWM channel 1, output B."]
    #[inline(always)]
    pub fn mc_1b(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Mc1b)
    }
    #[doc = "Slave Select for SSP1."]
    #[inline(always)]
    pub fn ssp1_ssel(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Ssp1Ssel)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_12(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::LcdVd12)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_20(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::LcdVd20)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[26\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_26Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_26Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_26Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_26Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_26Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_26Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[26\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_26::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_26::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_26Spec;
impl crate::RegisterSpec for P1_26Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_26::R`](R) reader structure"]
impl crate::Readable for P1_26Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_26::W`](W) writer structure"]
impl crate::Writable for P1_26Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_26 to value 0x30"]
impl crate::Resettable for P1_26Spec {
