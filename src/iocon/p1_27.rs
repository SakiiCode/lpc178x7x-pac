...
pub type R = crate::R<P1_27Spec>;
#[doc = "Register `P1_27` writer"]
pub type W = crate::W<P1_27Spec>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "USB port 1 OTG transceiver interrupt (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_int1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbInt1)
    }
    #[doc = "USB port 1 Over-Current status."]
    #[inline(always)]
    pub fn usb_ovrcr1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbOvrcr1)
    }
    #[doc = "Capture input for Timer 0, channel 1."]
    #[inline(always)]
    pub fn t0_cap1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::T0Cap1)
    }
    #[doc = "Selectable clock output."]
    #[inline(always)]
    pub fn clkout(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Clkout)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    ...
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_21(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::LcdVd21)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[27\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_27Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_27Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_27Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_27Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_27Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_27Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[27\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_27::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_27::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_27Spec;
impl crate::RegisterSpec for P1_27Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_27::R`](R) reader structure"]
impl crate::Readable for P1_27Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_27::W`](W) writer structure"]
impl crate::Writable for P1_27Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_27 to value 0x30"]
impl crate::Resettable for P1_27Spec {
