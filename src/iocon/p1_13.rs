...
pub type R = crate::R<P1_13Spec>;
#[doc = "Register `P1_13` writer"]
pub type W = crate::W<P1_13Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_13(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P1_13)
    }
    #[doc = "Ethernet Receive Data Valid (MII interface)."]
    #[inline(always)]
    pub fn enet_rx_dv(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::EnetRxDv)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[13\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_13Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_13Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_13Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_13Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_13Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_13Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[13\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_13::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_13::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_13Spec;
impl crate::RegisterSpec for P1_13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_13::R`](R) reader structure"]
impl crate::Readable for P1_13Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_13::W`](W) writer structure"]
impl crate::Writable for P1_13Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_13 to value 0x30"]
impl crate::Resettable for P1_13Spec {
