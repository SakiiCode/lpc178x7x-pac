...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            ...
            2 => Some(Func::U1Dsr),
            3 => Some(Func::T2Mat1),
            5 => Some(Func::Tracedata1),
            7 => Some(Func::LcdEnabM),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn tracedata_1(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Tracedata1)
    }
    #[doc = "STN AC bias drive or TFT data enable output."]
    #[inline(always)]
    pub fn lcd_enab_m(self) -> &'a mut crate::W<REG> {
        self.variant(Func::LcdEnabM)
    }
}
