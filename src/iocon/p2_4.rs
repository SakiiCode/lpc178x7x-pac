...
pub type R = crate::R<P2_4Spec>;
#[doc = "Register `P2_4` writer"]
pub type W = crate::W<P2_4Spec>;
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Enum> {
        match self.bits {
            ...
            2 => Some(Enum::U1Dsr),
            3 => Some(Enum::T2Mat1),
            5 => Some(Enum::Tracedata1),
            7 => Some(Enum::LcdEnabM),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p2_4(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P2_4)
    }
    #[doc = "Pulse Width Modulator 1, channel 5 output."]
    #[inline(always)]
    pub fn pwm1_5(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Pwm1_5)
    }
    #[doc = "Data Set Ready input for UART1."]
    #[inline(always)]
    pub fn u1_dsr(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::U1Dsr)
    }
    #[doc = "Match output for Timer 2, channel 1."]
    #[inline(always)]
    ...
    #[doc = "Trace data, bit 1."]
    #[inline(always)]
    pub fn tracedata_1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Tracedata1)
    }
    #[doc = "STN AC bias drive or TFT data enable output."]
    #[inline(always)]
    pub fn lcd_enab_m(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::LcdEnabM)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[4\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P2_4Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P2_4Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P2_4Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P2_4Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P2_4Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P2_4Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P2\\[4\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p2_4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p2_4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P2_4Spec;
impl crate::RegisterSpec for P2_4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p2_4::R`](R) reader structure"]
impl crate::Readable for P2_4Spec {}
#[doc = "`write(|w| ..)` method takes [`p2_4::W`](W) writer structure"]
impl crate::Writable for P2_4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P2_4 to value 0x30"]
impl crate::Resettable for P2_4Spec {
