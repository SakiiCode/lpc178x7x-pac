...
pub type R = crate::R<P2_9Spec>;
#[doc = "Register `P2_9` writer"]
pub type W = crate::W<P2_9Spec>;
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Enum> {
        match self.bits {
            0 => Some(Enum::P2_9),
            1 => Some(Enum::UsbConnect1),
            2 => Some(Enum::U2Rxd),
            3 => Some(Enum::U4Rxd),
            4 => Some(Enum::EnetMdio),
            6 => Some(Enum::LcdVd3),
            7 => Some(Enum::LcdVd7),
            _ => None,
        }
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p2_9(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P2_9)
    }
    #[doc = "USB1 SoftConnect control. Signal used to switch an external 1.5 kW resistor under the software control. Used with the SoftConnect USB feature."]
    #[inline(always)]
    pub fn usb_connect1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbConnect1)
    }
    #[doc = "Receiver input for UART2."]
    #[inline(always)]
    pub fn u2_rxd(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::U2Rxd)
    }
    #[doc = "Receiver input for USART4."]
    #[inline(always)]
    pub fn u4_rxd(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::U4Rxd)
    }
    #[doc = "Ethernet MIIM data input and output."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[9\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P2_9Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P2_9Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P2_9Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P2_9Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P2_9Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P2_9Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P2\\[9\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p2_9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p2_9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P2_9Spec;
impl crate::RegisterSpec for P2_9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p2_9::R`](R) reader structure"]
impl crate::Readable for P2_9Spec {}
#[doc = "`write(|w| ..)` method takes [`p2_9::W`](W) writer structure"]
impl crate::Writable for P2_9Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P2_9 to value 0x30"]
impl crate::Resettable for P2_9Spec {
