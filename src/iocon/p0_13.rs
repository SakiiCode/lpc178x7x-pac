...
pub type R = crate::R<P0_13Spec>;
#[doc = "Register `P0_13` writer"]
pub type W = crate::W<P0_13Spec>;
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[13\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P0_13Spec> {
        FuncW::new(self, 0)
    }
}
#[doc = "I/O configuration register for pin P0\\[13\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p0_13::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p0_13::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P0_13Spec;
impl crate::RegisterSpec for P0_13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p0_13::R`](R) reader structure"]
impl crate::Readable for P0_13Spec {}
#[doc = "`write(|w| ..)` method takes [`p0_13::W`](W) writer structure"]
impl crate::Writable for P0_13Spec {
