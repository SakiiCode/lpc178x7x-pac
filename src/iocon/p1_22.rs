...
pub type R = crate::R<P1_22Spec>;
#[doc = "Register `P1_22` writer"]
pub type W = crate::W<P1_22Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_22(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P1_22)
    }
    #[doc = "Differential receive data for USB port 1 (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_rcv1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbRcv1)
    }
    #[doc = "Power Status for USB port 1 (host power switch)."]
    #[inline(always)]
    pub fn usb_pwrd1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbPwrd1)
    }
    #[doc = "Match output for Timer 1, channel 0."]
    #[inline(always)]
    pub fn t1_mat0(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::T1Mat0)
    }
    #[doc = "Motor control PWM channel 0, output B."]
    #[inline(always)]
    pub fn mc_0b(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Mc0b)
    }
    #[doc = "Master Out Slave In for SSP1."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[22\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_22Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_22Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_22Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_22Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_22Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_22Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[22\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_22::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_22::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_22Spec;
impl crate::RegisterSpec for P1_22Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_22::R`](R) reader structure"]
impl crate::Readable for P1_22Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_22::W`](W) writer structure"]
impl crate::Writable for P1_22Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_22 to value 0x30"]
impl crate::Resettable for P1_22Spec {
