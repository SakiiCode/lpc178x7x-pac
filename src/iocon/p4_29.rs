...
pub type R = crate::R<P4_29Spec>;
#[doc = "Register `P4_29` writer"]
pub type W = crate::W<P4_29Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p4_29(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P4_29)
    }
    #[doc = "LOW active Byte Lane select signal 3."]
    #[inline(always)]
    pub fn emc_bls3(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::EmcBls3)
    }
    #[doc = "Receiver input for UART3."]
    #[inline(always)]
    pub fn u3_rxd(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::U3Rxd)
    }
    #[doc = "Match output for Timer 2, channel 1."]
    #[inline(always)]
    ...
    #[doc = "I2C2 clock input/output (this pin does not use a specialized I2C pad)."]
    #[inline(always)]
    pub fn i2c2_scl(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::I2c2Scl)
    }
    #[doc = "LCD data."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[29\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P4_29Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P4_29Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P4_29Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P4_29Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P4_29Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P4_29Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P4\\[29\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p4_29::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p4_29::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P4_29Spec;
impl crate::RegisterSpec for P4_29Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p4_29::R`](R) reader structure"]
impl crate::Readable for P4_29Spec {}
#[doc = "`write(|w| ..)` method takes [`p4_29::W`](W) writer structure"]
impl crate::Writable for P4_29Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P4_29 to value 0x30"]
impl crate::Resettable for P4_29Spec {
