...
pub type R = crate::R<P1_29Spec>;
#[doc = "Register `P1_29` writer"]
pub type W = crate::W<P1_29Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_29(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P1_29)
    }
    #[doc = "USB port 1 I2C serial data (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_sda1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbSda1)
    }
    #[doc = "Capture input for PWM1, channel 1."]
    #[inline(always)]
    pub fn pwm1_cap1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Pwm1Cap1)
    }
    #[doc = "Match output for Timer 0, channel 1."]
    #[inline(always)]
    pub fn t0_mat1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::T0Mat1)
    }
    #[doc = "Motor control PWM channel 2, output B."]
    #[inline(always)]
    pub fn mc_2b(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Mc2b)
    }
    #[doc = "Transmitter output for USART4 (input/output in smart card mode)."]
    #[inline(always)]
    pub fn u4_txd(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::U4Txd)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_15(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::LcdVd15)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_23(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::LcdVd23)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[29\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_29Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_29Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_29Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_29Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_29Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_29Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[29\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_29::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_29::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_29Spec;
impl crate::RegisterSpec for P1_29Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_29::R`](R) reader structure"]
impl crate::Readable for P1_29Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_29::W`](W) writer structure"]
impl crate::Writable for P1_29Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_29 to value 0x30"]
impl crate::Resettable for P1_29Spec {
