...
pub type R = crate::R<P5_1Spec>;
#[doc = "Register `P5_1` writer"]
pub type W = crate::W<P5_1Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p5_1(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P5_1)
    }
    #[doc = "External memory address line 25."]
    #[inline(always)]
    pub fn emc_a_25(self) -> &'a mut crate::W<REG> {
        self.variant(Func::EmcA25)
    }
    #[doc = "Master In Slave Out for SSP2."]
    #[inline(always)]
    pub fn ssp2_miso(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Ssp2Miso)
    }
    #[doc = "Match output for Timer 2, channel 3."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P5\\[1\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P5_1Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P5_1Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P5_1Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P5_1Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P5_1Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P5_1Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P5\\[1\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p5_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p5_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P5_1Spec;
impl crate::RegisterSpec for P5_1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p5_1::R`](R) reader structure"]
impl crate::Readable for P5_1Spec {}
#[doc = "`write(|w| ..)` method takes [`p5_1::W`](W) writer structure"]
impl crate::Writable for P5_1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P5_1 to value 0x30"]
impl crate::Resettable for P5_1Spec {
