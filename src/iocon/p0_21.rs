...
pub type R = crate::R<P0_21Spec>;
#[doc = "Register `P0_21` writer"]
pub type W = crate::W<P0_21Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p0_21(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P0_21)
    }
    #[doc = "Ring Indicator input for UART1."]
    #[inline(always)]
    pub fn u1_ri(self) -> &'a mut crate::W<REG> {
        self.variant(Func::U1Ri)
    }
    #[doc = "Power Supply Enable for external SD card power supply."]
    #[inline(always)]
    pub fn sd_pwr(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SdPwr)
    }
    #[doc = "RS-485/EIA-485 output enable signal for UART4."]
    #[inline(always)]
    pub fn u4_oe(self) -> &'a mut crate::W<REG> {
        self.variant(Func::U4Oe)
    }
    #[doc = "CAN1 receiver input."]
    #[inline(always)]
    pub fn can_rd1(self) -> &'a mut crate::W<REG> {
        self.variant(Func::CanRd1)
    }
    #[doc = "USART 4 clock input or output in synchronous mode."]
    #[inline(always)]
    pub fn u4_sclk(self) -> &'a mut crate::W<REG> {
        self.variant(Func::U4Sclk)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[21\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P0_21Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P0_21Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P0_21Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P0_21Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P0_21Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P0_21Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P0\\[21\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p0_21::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p0_21::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P0_21Spec;
impl crate::RegisterSpec for P0_21Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p0_21::R`](R) reader structure"]
impl crate::Readable for P0_21Spec {}
#[doc = "`write(|w| ..)` method takes [`p0_21::W`](W) writer structure"]
impl crate::Writable for P0_21Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P0_21 to value 0x30"]
impl crate::Resettable for P0_21Spec {
