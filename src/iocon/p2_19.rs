...
pub type R = crate::R<P2_19Spec>;
#[doc = "Register `P2_19` writer"]
pub type W = crate::W<P2_19Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p2_19(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P2_19)
    }
    #[doc = "SDRAM clock 1."]
    #[inline(always)]
    pub fn emc_clk_1(self) -> &'a mut crate::W<REG> {
        self.variant(Func::EmcClk1)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[19\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P2_19Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P2_19Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P2_19Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P2_19Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 7 - Selects Analog/Digital mode."]
    #[inline(always)]
    pub fn admode(&mut self) -> AdmodeW<'_, P2_19Spec> {
        AdmodeW::new(self, 7)
    }
    #[doc = "Bit 8 - Selects 10 ns input glitch filter."]
    #[inline(always)]
    pub fn filtr(&mut self) -> FiltrW<'_, P2_19Spec> {
        FiltrW::new(self, 8)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P2_19Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P2\\[19\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p2_19::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p2_19::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P2_19Spec;
impl crate::RegisterSpec for P2_19Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p2_19::R`](R) reader structure"]
impl crate::Readable for P2_19Spec {}
#[doc = "`write(|w| ..)` method takes [`p2_19::W`](W) writer structure"]
impl crate::Writable for P2_19Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P2_19 to value 0x01b0"]
impl crate::Resettable for P2_19Spec {
