...
pub type R = crate::R<P0_9Spec>;
#[doc = "Register `P0_9` writer"]
pub type W = crate::W<P0_9Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p0_9(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P0_9)
    }
    #[doc = "I2S transmit data. It is driven by the transmitter and read by the receiver. Corresponds to the signal SD in the I2S-bus specification."]
    #[inline(always)]
    pub fn i2s_tx_sda(self) -> &'a mut crate::W<REG> {
        self.variant(Func::I2sTxSda)
    }
    #[doc = "Master Out Slave In for SSP1."]
    #[inline(always)]
    ...
    #[doc = "Match output for Timer 2, channel 3."]
    #[inline(always)]
    pub fn t2_mat3(self) -> &'a mut crate::W<REG> {
        self.variant(Func::T2Mat3)
    }
    #[doc = "Event input 2 to Event Monitor/Recorder."]
    #[inline(always)]
    pub fn rtc_ev2(self) -> &'a mut crate::W<REG> {
        self.variant(Func::RtcEv2)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_17(self) -> &'a mut crate::W<REG> {
        self.variant(Func::LcdVd17)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Filter {
    #[doc = "0: Noise pulses below approximately 10 ns are filtered out."]
    Enabled = 0,
    #[doc = "1: No input filtering is done."]
    Disabled = 1,
}
impl From<Filter> for bool {
    #[inline(always)]
    fn from(variant: Filter) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FILTER` reader - Glitch filter control"]
pub type FilterR = crate::BitReader<Filter>;
impl FilterR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Filter {
        match self.bits {
            false => Filter::Enabled,
            true => Filter::Disabled,
        }
    }
    ...
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == Filter::Disabled
    }
}
#[doc = "Field `FILTER` writer - Glitch filter control"]
pub type FilterW<'a, REG> = crate::BitWriter<'a, REG, Filter>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(Filter::Enabled)
    }
    #[doc = "No input filtering is done."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Filter::Disabled)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[9\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P0_9Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P0_9Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P0_9Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P0_9Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 8 - Glitch filter control"]
    #[inline(always)]
    pub fn filter(&mut self) -> FilterW<'_, P0_9Spec> {
        FilterW::new(self, 8)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P0_9Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P0_9Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P0\\[9\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p0_9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p0_9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P0_9Spec;
impl crate::RegisterSpec for P0_9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p0_9::R`](R) reader structure"]
impl crate::Readable for P0_9Spec {}
#[doc = "`write(|w| ..)` method takes [`p0_9::W`](W) writer structure"]
impl crate::Writable for P0_9Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P0_9 to value 0xa0"]
impl crate::Resettable for P0_9Spec {
