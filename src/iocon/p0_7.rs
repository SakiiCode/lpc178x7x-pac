...
pub type R = crate::R<P0_7Spec>;
#[doc = "Register `P0_7` writer"]
pub type W = crate::W<P0_7Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p0_7(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P0_7)
    }
    #[doc = "I2S transmit clock. It is driven by the master and received by the slave. Corresponds to the signal SCK in the I2S-bus specification."]
    #[inline(always)]
    ...
    pub fn ssp1_sck(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Ssp1Sck)
    }
    #[doc = "Match output for Timer 2, channel 1."]
    #[inline(always)]
    pub fn t2_mat1(self) -> &'a mut crate::W<REG> {
        self.variant(Func::T2Mat1)
    }
    #[doc = "Event input 0 to Event Monitor/Recorder."]
    #[inline(always)]
    pub fn rtc_ev0(self) -> &'a mut crate::W<REG> {
        self.variant(Func::RtcEv0)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_9(self) -> &'a mut crate::W<REG> {
        self.variant(Func::LcdVd9)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[7\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P0_7Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P0_7Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P0_7Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P0_7Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 8 - Glitch filter control"]
    #[inline(always)]
    pub fn filter(&mut self) -> FilterW<'_, P0_7Spec> {
        FilterW::new(self, 8)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P0_7Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P0_7Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P0\\[7\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p0_7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p0_7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P0_7Spec;
impl crate::RegisterSpec for P0_7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p0_7::R`](R) reader structure"]
impl crate::Readable for P0_7Spec {}
#[doc = "`write(|w| ..)` method takes [`p0_7::W`](W) writer structure"]
impl crate::Writable for P0_7Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P0_7 to value 0xa0"]
impl crate::Resettable for P0_7Spec {
