...
pub type R = crate::R<P2_30Spec>;
#[doc = "Register `P2_30` writer"]
pub type W = crate::W<P2_30Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p2_30(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P2_30)
    }
    #[doc = "Data mask 2 used with SDRAM and static devices."]
    #[inline(always)]
    pub fn emc_dqm2(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::EmcDqm2)
    }
    #[doc = "I2C2 data input/output (this pin does not use a specialized I2C pad)."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[30\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P2_30Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P2_30Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P2_30Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P2_30Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P2_30Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P2_30Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P2\\[30\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p2_30::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p2_30::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P2_30Spec;
impl crate::RegisterSpec for P2_30Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p2_30::R`](R) reader structure"]
impl crate::Readable for P2_30Spec {}
#[doc = "`write(|w| ..)` method takes [`p2_30::W`](W) writer structure"]
impl crate::Writable for P2_30Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P2_30 to value 0x30"]
impl crate::Resettable for P2_30Spec {
