...
pub type R = crate::R<P4_9Spec>;
#[doc = "Register `P4_9` writer"]
pub type W = crate::W<P4_9Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p4_9(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P4_9)
    }
    #[doc = "External memory address line 9."]
    #[inline(always)]
    pub fn emc_a_9(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::EmcA9)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[9\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P4_9Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P4_9Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P4_9Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P4_9Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P4_9Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P4_9Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P4\\[9\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p4_9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p4_9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P4_9Spec;
impl crate::RegisterSpec for P4_9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p4_9::R`](R) reader structure"]
impl crate::Readable for P4_9Spec {}
#[doc = "`write(|w| ..)` method takes [`p4_9::W`](W) writer structure"]
impl crate::Writable for P4_9Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P4_9 to value 0x30"]
impl crate::Resettable for P4_9Spec {
