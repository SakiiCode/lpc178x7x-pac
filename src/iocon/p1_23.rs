...
pub type R = crate::R<P1_23Spec>;
#[doc = "Register `P1_23` writer"]
pub type W = crate::W<P1_23Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_23(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P1_23)
    }
    #[doc = "D+ receive data for USB port 1 (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_rx_dp1(self) -> &'a mut crate::W<REG> {
        self.variant(Func::UsbRxDp1)
    }
    #[doc = "Pulse Width Modulator 1, channel 4 output."]
    #[inline(always)]
    pub fn pwm1_4(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Pwm1_4)
    }
    #[doc = "Quadrature Encoder Interface PHB input."]
    #[inline(always)]
    pub fn qei_phb(self) -> &'a mut crate::W<REG> {
        self.variant(Func::QeiPhb)
    }
    #[doc = "Motor control PWM channel 1 feedback input."]
    #[inline(always)]
    pub fn mc_fb1(self) -> &'a mut crate::W<REG> {
        self.variant(Func::McFb1)
    }
    #[doc = "Master In Slave Out for SSP0."]
    #[inline(always)]
    pub fn ssp0_miso(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Ssp0Miso)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    ...
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_13(self) -> &'a mut crate::W<REG> {
        self.variant(Func::LcdVd13)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[23\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_23Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_23Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_23Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_23Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_23Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_23Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[23\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_23::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_23::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_23Spec;
impl crate::RegisterSpec for P1_23Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_23::R`](R) reader structure"]
impl crate::Readable for P1_23Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_23::W`](W) writer structure"]
impl crate::Writable for P1_23Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_23 to value 0x30"]
impl crate::Resettable for P1_23Spec {
