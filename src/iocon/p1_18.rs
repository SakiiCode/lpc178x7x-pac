...
pub type R = crate::R<P1_18Spec>;
#[doc = "Register `P1_18` writer"]
pub type W = crate::W<P1_18Spec>;
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Enum> {
        match self.bits {
            0 => Some(Enum::P1_18),
            1 => Some(Enum::UsbUpLed1),
            2 => Some(Enum::Pwm1_1),
            3 => Some(Enum::T1Cap0),
            5 => Some(Enum::Ssp1Miso),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_18(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P1_18)
    }
    #[doc = "It is LOW when the device is configured (non-control endpoints enabled), or when the host is enabled and has detected a device on the bus. It is HIGH when the device is not configured, or when host is enabled and has not detected a device on the bus, or during global suspend. It transitions between LOW and HIGH (flashes) when the host is enabled and detects activity on the bus."]
    #[inline(always)]
    pub fn usb_up_led1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::UsbUpLed1)
    }
    #[doc = "Pulse Width Modulator 1, channel 1 output."]
    #[inline(always)]
    pub fn pwm1_1(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Pwm1_1)
    }
    #[doc = "Capture input for Timer 1, channel 0."]
    #[inline(always)]
    pub fn t1_cap0(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::T1Cap0)
    }
    #[doc = "Master In Slave Out for SSP1."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[18\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_18Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_18Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_18Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_18Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_18Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_18Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[18\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_18::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_18::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_18Spec;
impl crate::RegisterSpec for P1_18Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_18::R`](R) reader structure"]
impl crate::Readable for P1_18Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_18::W`](W) writer structure"]
impl crate::Writable for P1_18Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_18 to value 0x30"]
impl crate::Resettable for P1_18Spec {
