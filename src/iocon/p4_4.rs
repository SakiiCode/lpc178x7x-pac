...
pub type R = crate::R<P4_4Spec>;
#[doc = "Register `P4_4` writer"]
pub type W = crate::W<P4_4Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p4_4(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P4_4)
    }
    #[doc = "External memory address line 4."]
    #[inline(always)]
    pub fn emc_a_4(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::EmcA4)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[4\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P4_4Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P4_4Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P4_4Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P4_4Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P4_4Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P4_4Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P4\\[4\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p4_4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p4_4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P4_4Spec;
impl crate::RegisterSpec for P4_4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p4_4::R`](R) reader structure"]
impl crate::Readable for P4_4Spec {}
#[doc = "`write(|w| ..)` method takes [`p4_4::W`](W) writer structure"]
impl crate::Writable for P4_4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P4_4 to value 0x30"]
impl crate::Resettable for P4_4Spec {
