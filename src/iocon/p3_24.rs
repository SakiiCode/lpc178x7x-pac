...
pub type R = crate::R<P3_24Spec>;
#[doc = "Register `P3_24` writer"]
pub type W = crate::W<P3_24Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p3_24(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P3_24)
    }
    #[doc = "External memory data line 24."]
    #[inline(always)]
    pub fn emc_d_24(self) -> &'a mut crate::W<REG> {
        self.variant(Func::EmcD24)
    }
    #[doc = "Pulse Width Modulator 1, output 1."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[24\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P3_24Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P3_24Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P3_24Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P3_24Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P3_24Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P3_24Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P3\\[24\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p3_24::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p3_24::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P3_24Spec;
impl crate::RegisterSpec for P3_24Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p3_24::R`](R) reader structure"]
impl crate::Readable for P3_24Spec {}
#[doc = "`write(|w| ..)` method takes [`p3_24::W`](W) writer structure"]
impl crate::Writable for P3_24Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P3_24 to value 0x30"]
impl crate::Resettable for P3_24Spec {
