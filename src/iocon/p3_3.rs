...
pub type R = crate::R<P3_3Spec>;
#[doc = "Register `P3_3` writer"]
pub type W = crate::W<P3_3Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p3_3(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P3_3)
    }
    #[doc = "External memory data line 3."]
    #[inline(always)]
    pub fn emc_d_3(self) -> &'a mut crate::W<REG> {
        self.variant(Func::EmcD3)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[3\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P3_3Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P3_3Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P3_3Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P3_3Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P3_3Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P3_3Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P3\\[3\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p3_3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p3_3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P3_3Spec;
impl crate::RegisterSpec for P3_3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p3_3::R`](R) reader structure"]
impl crate::Readable for P3_3Spec {}
#[doc = "`write(|w| ..)` method takes [`p3_3::W`](W) writer structure"]
impl crate::Writable for P3_3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P3_3 to value 0x30"]
impl crate::Resettable for P3_3Spec {
