...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Enum> {
        match self.bits {
            0 => Some(Enum::P1_8),
            1 => Some(Enum::EnetCrsCrsDv),
            3 => Some(Enum::T3Mat1),
            4 => Some(Enum::Ssp2Ssel),
            _ => None,
        }
    }
