...
pub type R = crate::R<P1_8Spec>;
#[doc = "Register `P1_8` writer"]
pub type W = crate::W<P1_8Spec>;
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            0 => Some(Func::P1_8),
            1 => Some(Func::EnetCrsCrsDv),
            3 => Some(Func::T3Mat1),
            4 => Some(Func::Ssp2Ssel),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p1_8(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P1_8)
    }
    #[doc = "Ethernet Carrier Sense (MII interface) or Ethernet Carrier Sense/Data Valid (RMII interface)."]
    #[inline(always)]
    pub fn enet_crs_crs_dv(self) -> &'a mut crate::W<REG> {
        self.variant(Func::EnetCrsCrsDv)
    }
    #[doc = "Match output for Timer 3, channel 1."]
    #[inline(always)]
    pub fn t3_mat1(self) -> &'a mut crate::W<REG> {
        self.variant(Func::T3Mat1)
    }
    #[doc = "Slave Select for SSP2."]
    #[inline(always)]
    pub fn ssp2_ssel(self) -> &'a mut crate::W<REG> {
        self.variant(Func::Ssp2Ssel)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[8\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P1_8Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P1_8Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P1_8Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P1_8Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P1_8Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P1_8Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P1\\[8\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p1_8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1_8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1_8Spec;
impl crate::RegisterSpec for P1_8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1_8::R`](R) reader structure"]
impl crate::Readable for P1_8Spec {}
#[doc = "`write(|w| ..)` method takes [`p1_8::W`](W) writer structure"]
impl crate::Writable for P1_8Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P1_8 to value 0x30"]
impl crate::Resettable for P1_8Spec {
