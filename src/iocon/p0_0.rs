...
pub type R = crate::R<P0_0Spec>;
#[doc = "Register `P0_0` writer"]
pub type W = crate::W<P0_0Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p0_0(self) -> &'a mut crate::W<REG> {
        self.variant(Func::P0_0)
    }
    #[doc = "CAN1 receiver input."]
    #[inline(always)]
    ...
    #[doc = "Transmitter output for UART0."]
    #[inline(always)]
    pub fn u0_txd(self) -> &'a mut crate::W<REG> {
        self.variant(Func::U0Txd)
    }
}
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[0\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P0_0Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P0_0Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P0_0Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P0_0Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P0_0Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P0_0Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P0\\[0\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p0_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p0_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P0_0Spec;
impl crate::RegisterSpec for P0_0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p0_0::R`](R) reader structure"]
impl crate::Readable for P0_0Spec {}
#[doc = "`write(|w| ..)` method takes [`p0_0::W`](W) writer structure"]
impl crate::Writable for P0_0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P0_0 to value 0x30"]
impl crate::Resettable for P0_0Spec {
