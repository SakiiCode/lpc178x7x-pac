...
pub type R = crate::R<P2_27Spec>;
#[doc = "Register `P2_27` writer"]
pub type W = crate::W<P2_27Spec>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "General purpose digital input/output pin."]
    #[inline(always)]
    pub fn p2_27(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::P2_27)
    }
    #[doc = "SDRAM clock enable 3."]
    #[inline(always)]
    pub fn emc_cke3(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::EmcCke3)
    }
    #[doc = "Master Out Slave In for SSP0."]
    #[inline(always)]
    pub fn ssp0_mosi(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Ssp0Mosi)
    }
    #[doc = "Match output for Timer 3, channel 1."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[27\\]"]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, P2_27Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, P2_27Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, P2_27Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 6 - Invert input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, P2_27Spec> {
        InvW::new(self, 6)
    }
    #[doc = "Bit 9 - Driver slew rate"]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, P2_27Spec> {
        SlewW::new(self, 9)
    }
    #[doc = "Bit 10 - Open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, P2_27Spec> {
        OdW::new(self, 10)
    }
}
#[doc = "I/O configuration register for pin P2\\[27\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`p2_27::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p2_27::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P2_27Spec;
impl crate::RegisterSpec for P2_27Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p2_27::R`](R) reader structure"]
impl crate::Readable for P2_27Spec {}
#[doc = "`write(|w| ..)` method takes [`p2_27::W`](W) writer structure"]
impl crate::Writable for P2_27Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P2_27 to value 0x30"]
impl crate::Resettable for P2_27Spec {
