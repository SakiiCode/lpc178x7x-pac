    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn no_interrupt_or_wake(self) -> &'a mut crate::W<REG> {
        self.variant(IntwakeEn0::NoInterruptOrWake)
    }
    #[doc = "An event in channel 0 will trigger an (RTC) interrupt and a wake-up request."]
    #[inline(always)]
    pub fn an_event_in_channel_(self) -> &'a mut crate::W<REG> {
        self.variant(IntwakeEn0::AnEventInChannel_)
    }
}
...
impl IntwakeEn1R {
    ...
    pub const fn variant(&self) -> IntwakeEn1 {
        match self.bits {
            false => IntwakeEn1::NoInterruptOrWake,
    ...
    #[inline(always)]
    pub fn is_no_interrupt_or_wake(&self) -> bool {
        *self == IntwakeEn1::NoInterruptOrWake
    }
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn no_interrupt_or_wake(self) -> &'a mut crate::W<REG> {
        self.variant(IntwakeEn1::NoInterruptOrWake)
    }
    #[doc = "An event in channel 1 will trigger an (RTC) interrupt and a wake-up request."]
    #[inline(always)]
...
impl IntwakeEn2R {
    ...
    pub const fn variant(&self) -> IntwakeEn2 {
        match self.bits {
            false => IntwakeEn2::NoInterruptOrWake,
    ...
    #[inline(always)]
    pub fn is_no_interrupt_or_wake(&self) -> bool {
        *self == IntwakeEn2::NoInterruptOrWake
    }
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn no_interrupt_or_wake(self) -> &'a mut crate::W<REG> {
        self.variant(IntwakeEn2::NoInterruptOrWake)
    }
    #[doc = "An event in channel 2 will trigger an (RTC) interrupt and a wake-up request."]
    #[inline(always)]
    pub fn wakeup(self) -> &'a mut crate::W<REG> {
