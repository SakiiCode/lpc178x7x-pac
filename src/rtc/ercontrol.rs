    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No interrupt or wakeup will be generated by event channel 0."]
    #[inline(always)]
    pub fn no_interrupt_or_wake(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::NoInterruptOrWake)
    }
    #[doc = "An event in channel 0 will trigger an (RTC) interrupt and a wake-up request."]
    #[inline(always)]
    pub fn an_event_in_channel_(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::AnEventInChannel_)
    }
}
...
pub type GpclearEn0R = crate::BitReader<Enum>;
impl GpclearEn0R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type GpclearEn0W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn nogpreg(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Nogpreg)
    }
    #[doc = "An event in channel 0 will clear the general purpose registers asynchronously."]
    #[inline(always)]
    pub fn clrgpreg(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Clrgpreg)
    }
}
...
pub type Pol0R = crate::BitReader<Enum>;
impl Pol0R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Pol0W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn neg(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Neg)
    }
    #[doc = "A channel 0 event is defined as a positive edge on RTC_EV0."]
    #[inline(always)]
    pub fn pos(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Pos)
    }
}
...
pub type Ev0InputEnR = crate::BitReader<Enum>;
impl Ev0InputEnR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Ev0InputEnW<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type IntwakeEn1R = crate::BitReader<Enum>;
impl IntwakeEn1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type IntwakeEn1W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type GpclearEn1R = crate::BitReader<Enum>;
impl GpclearEn1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type GpclearEn1W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Pol1R = crate::BitReader<Enum>;
impl Pol1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Pol1W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Ev1InputEnR = crate::BitReader<Enum>;
impl Ev1InputEnR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Ev1InputEnW<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type IntwakeEn2R = crate::BitReader<Enum>;
impl IntwakeEn2R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type IntwakeEn2W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type GpclearEn2R = crate::BitReader<Enum>;
impl GpclearEn2R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type GpclearEn2W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Pol2R = crate::BitReader<Enum>;
impl Pol2R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Pol2W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Ev2InputEnR = crate::BitReader<Enum>;
impl Ev2InputEnR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Ev2InputEnW<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type ErmodeR = crate::FieldReader<Enum>;
impl ErmodeR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
        match self.bits {
            0 => Enum::Disabled,
            1 => Enum::EnableEventMonitor16hz,
            2 => Enum::EnableEventMonitor64hz,
            3 => Enum::EnableEventMonitor1khz,
            _ => unreachable!(),
        }
    }
    ...
    pub fn is_enable_event_monitor16hz(&self) -> bool {
        *self == Enum::EnableEventMonitor16hz
    }
    ...
    pub fn is_enable_event_monitor64hz(&self) -> bool {
        *self == Enum::EnableEventMonitor64hz
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn enable_event_monitor16hz(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::EnableEventMonitor16hz)
    }
    #[doc = "Enable Event Monitor/Recorder and select a 64 Hz sample clock for event input edge detection and glitch suppression. Pulses (in either direction) shorter than 15.6 ms to 31.2 ms will be filtered out."]
    #[inline(always)]
    pub fn enable_event_monitor64hz(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::EnableEventMonitor64hz)
    }
    #[doc = "Enable Event Monitor/Recorder and select a 1 kHz sample clock for event input edge detection and glitch suppression. Pulses (in either direction) shorter than 1 ms to 2 ms will be filtered out."]
    #[inline(always)]
    pub fn enable_event_monitor1khz(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::EnableEventMonitor1khz)
    }
}
impl R {
