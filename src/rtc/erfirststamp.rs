...
pub type R = crate::R<ErfirststampSpec>;
...
#[doc = "Event Monitor/Recorder First Stamp register for channel 0. Retains the time stamp for the first event on channel 0.\n\nYou can [`read`](crate::Reg::read) this register and get [`erfirststamp::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ErfirststampSpec;
impl crate::RegisterSpec for ErfirststampSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`erfirststamp::R`](R) reader structure"]
impl crate::Readable for ErfirststampSpec {}
#[doc = "`reset()` method sets ERFIRSTSTAMP%s to value 0"]
impl crate::Resettable for ErfirststampSpec {}
