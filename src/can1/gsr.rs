...
pub type RbsR = crate::BitReader<Enum>;
impl RbsR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
        match self.bits {
            false => Enum::EmptyNoMessageIs,
            true => Enum::FullAtLeastOneC,
        }
    }
    #[doc = "Empty. No message is available."]
    #[inline(always)]
    pub fn is_empty_no_message_is(&self) -> bool {
        *self == Enum::EmptyNoMessageIs
    }
...
pub type DosR = crate::BitReader<Enum>;
impl DosR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
        match self.bits {
            false => Enum::AbsentNoDataOver,
            true => Enum::OverrunAMessageW,
        }
    }
...
pub type TbsR = crate::BitReader<Enum>;
impl TbsR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
        match self.bits {
            false => Enum::LockedAtLeastOne,
            true => Enum::ReleasedAllThree_,
        }
    }
...
pub type TcsR = crate::BitReader<Enum>;
impl TcsR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
        match self.bits {
            false => Enum::IncompleteAtLeast,
            true => Enum::CompleteAllReques,
        }
    }
...
pub type TsR = crate::BitReader<Enum>;
impl TsR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type EsR = crate::BitReader<Enum>;
impl EsR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
        match self.bits {
            false => Enum::OkBothErrorCount,
            true => Enum::ErrorOneOrBothO,
        }
    }
    #[doc = "OK. Both error counters are below the Error Warning Limit."]
    #[inline(always)]
    pub fn is_ok_both_error_count(&self) -> bool {
        *self == Enum::OkBothErrorCount
    }
...
pub type BsR = crate::BitReader<Enum>;
impl BsR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
        match self.bits {
            false => Enum::BusOnTheCanCont,
            true => Enum::BusOffTheCanCon,
        }
    }
    #[doc = "Bus-on. The CAN Controller is involved in bus activities"]
    #[inline(always)]
    pub fn is_bus_on_the_can_cont(&self) -> bool {
        *self == Enum::BusOnTheCanCont
    }
