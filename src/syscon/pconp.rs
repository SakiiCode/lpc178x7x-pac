...
pub type PclcdR = crate::BitReader;
#[doc = "Field `PCLCD` writer - LCD controller power/clock control bit."]
pub type PclcdW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pcpwm0R = crate::BitReader;
#[doc = "Field `PCPWM0` writer - PWM0 power/clock control bit."]
pub type Pcpwm0W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pcuart4R = crate::BitReader;
#[doc = "Field `PCUART4` writer - UART4 power/clock control bit."]
pub type Pcuart4W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PcemcR = crate::BitReader;
#[doc = "Field `PCEMC` writer - External Memory Controller power/clock control bit."]
pub type PcemcW<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `PCSPIFI` reader - SPI Flash Interface power/clock control bit (LPC1773 only)."]
pub type PcspifiR = crate::BitReader;
#[doc = "Field `PCSPIFI` writer - SPI Flash Interface power/clock control bit (LPC1773 only)."]
pub type PcspifiW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pcssp2R = crate::BitReader;
#[doc = "Field `PCSSP2` writer - SSP2 interface power/clock control bit."]
pub type Pcssp2W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PcsdcR = crate::BitReader;
#[doc = "Field `PCSDC` writer - SD Card interface power/clock control bit."]
pub type PcsdcW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn pclcd(&self) -> PclcdR {
        PclcdR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn pcpwm0(&self) -> Pcpwm0R {
        Pcpwm0R::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn pcuart4(&self) -> Pcuart4R {
        Pcuart4R::new(((self.bits >> 8) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn pcemc(&self) -> PcemcR {
        PcemcR::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn pcspifi(&self) -> PcspifiR {
        PcspifiR::new(((self.bits >> 16) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn pcssp2(&self) -> Pcssp2R {
        Pcssp2R::new(((self.bits >> 20) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn pcsdc(&self) -> PcsdcR {
        PcsdcR::new(((self.bits >> 28) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - LCD controller power/clock control bit."]
    #[inline(always)]
    pub fn pclcd(&mut self) -> PclcdW<'_, PconpSpec> {
        PclcdW::new(self, 0)
    }
    #[doc = "Bit 1 - Timer/Counter 0 power/clock control bit."]
    #[inline(always)]
    pub fn pctim0(&mut self) -> Pctim0W<'_, PconpSpec> {
        Pctim0W::new(self, 1)
    }
    #[doc = "Bit 2 - Timer/Counter 1 power/clock control bit."]
    #[inline(always)]
    pub fn pctim1(&mut self) -> Pctim1W<'_, PconpSpec> {
        Pctim1W::new(self, 2)
    }
    #[doc = "Bit 3 - UART0 power/clock control bit."]
    #[inline(always)]
    pub fn pcuart0(&mut self) -> Pcuart0W<'_, PconpSpec> {
        Pcuart0W::new(self, 3)
    }
    #[doc = "Bit 4 - UART1 power/clock control bit."]
    #[inline(always)]
    pub fn pcuart1(&mut self) -> Pcuart1W<'_, PconpSpec> {
        Pcuart1W::new(self, 4)
    }
    #[doc = "Bit 5 - PWM0 power/clock control bit."]
    #[inline(always)]
    pub fn pcpwm0(&mut self) -> Pcpwm0W<'_, PconpSpec> {
        Pcpwm0W::new(self, 5)
    }
    #[doc = "Bit 6 - PWM1 power/clock control bit."]
    #[inline(always)]
    pub fn pcpwm1(&mut self) -> Pcpwm1W<'_, PconpSpec> {
        Pcpwm1W::new(self, 6)
    }
    #[doc = "Bit 7 - I2C0 interface power/clock control bit."]
    #[inline(always)]
    pub fn pci2c0(&mut self) -> Pci2c0W<'_, PconpSpec> {
        Pci2c0W::new(self, 7)
    }
    #[doc = "Bit 8 - UART4 power/clock control bit."]
    #[inline(always)]
    pub fn pcuart4(&mut self) -> Pcuart4W<'_, PconpSpec> {
        Pcuart4W::new(self, 8)
    }
    #[doc = "Bit 9 - RTC and Event Monitor/Recorder power/clock control bit."]
    #[inline(always)]
    pub fn pcrtc(&mut self) -> PcrtcW<'_, PconpSpec> {
        PcrtcW::new(self, 9)
    }
    #[doc = "Bit 10 - SSP 1 interface power/clock control bit."]
    #[inline(always)]
    pub fn pcssp1(&mut self) -> Pcssp1W<'_, PconpSpec> {
        Pcssp1W::new(self, 10)
    }
    #[doc = "Bit 11 - External Memory Controller power/clock control bit."]
    #[inline(always)]
    pub fn pcemc(&mut self) -> PcemcW<'_, PconpSpec> {
        PcemcW::new(self, 11)
    }
    #[doc = "Bit 12 - A/D converter (ADC) power/clock control bit. Note: Clear the PDN bit in the AD0CR before clearing this bit, and set this bit before attempting to set PDN."]
    #[inline(always)]
    pub fn pcadc(&mut self) -> PcadcW<'_, PconpSpec> {
        PcadcW::new(self, 12)
    }
    #[doc = "Bit 13 - CAN Controller 1 power/clock control bit."]
    #[inline(always)]
    pub fn pccan1(&mut self) -> Pccan1W<'_, PconpSpec> {
        Pccan1W::new(self, 13)
    }
    #[doc = "Bit 14 - CAN Controller 2 power/clock control bit."]
    #[inline(always)]
    pub fn pccan2(&mut self) -> Pccan2W<'_, PconpSpec> {
        Pccan2W::new(self, 14)
    }
    #[doc = "Bit 15 - Power/clock control bit for IOCON, GPIO, and GPIO interrupts."]
    #[inline(always)]
    pub fn pcgpio(&mut self) -> PcgpioW<'_, PconpSpec> {
        PcgpioW::new(self, 15)
    }
    #[doc = "Bit 16 - SPI Flash Interface power/clock control bit (LPC1773 only)."]
    #[inline(always)]
    pub fn pcspifi(&mut self) -> PcspifiW<'_, PconpSpec> {
        PcspifiW::new(self, 16)
    }
    #[doc = "Bit 17 - Motor Control PWM power/clock control bit."]
    #[inline(always)]
    pub fn pcmcpwm(&mut self) -> PcmcpwmW<'_, PconpSpec> {
        PcmcpwmW::new(self, 17)
    }
    #[doc = "Bit 18 - Quadrature Encoder Interface power/clock control bit."]
    #[inline(always)]
    pub fn pcqei(&mut self) -> PcqeiW<'_, PconpSpec> {
        PcqeiW::new(self, 18)
    }
    #[doc = "Bit 19 - I2C1 interface power/clock control bit."]
    #[inline(always)]
    pub fn pci2c1(&mut self) -> Pci2c1W<'_, PconpSpec> {
        Pci2c1W::new(self, 19)
    }
    #[doc = "Bit 20 - SSP2 interface power/clock control bit."]
    #[inline(always)]
    pub fn pcssp2(&mut self) -> Pcssp2W<'_, PconpSpec> {
        Pcssp2W::new(self, 20)
    }
    #[doc = "Bit 21 - SSP0 interface power/clock control bit."]
    #[inline(always)]
    pub fn pcssp0(&mut self) -> Pcssp0W<'_, PconpSpec> {
        Pcssp0W::new(self, 21)
    }
    #[doc = "Bit 22 - Timer 2 power/clock control bit."]
    #[inline(always)]
    pub fn pctim2(&mut self) -> Pctim2W<'_, PconpSpec> {
        Pctim2W::new(self, 22)
    }
    #[doc = "Bit 23 - Timer 3 power/clock control bit."]
    #[inline(always)]
    pub fn pctim3(&mut self) -> Pctim3W<'_, PconpSpec> {
        Pctim3W::new(self, 23)
    }
    #[doc = "Bit 24 - UART 2 power/clock control bit."]
    #[inline(always)]
    pub fn pcuart2(&mut self) -> Pcuart2W<'_, PconpSpec> {
        Pcuart2W::new(self, 24)
    }
    #[doc = "Bit 25 - UART 3 power/clock control bit."]
    #[inline(always)]
    pub fn pcuart3(&mut self) -> Pcuart3W<'_, PconpSpec> {
        Pcuart3W::new(self, 25)
    }
    #[doc = "Bit 26 - I2C interface 2 power/clock control bit."]
    #[inline(always)]
    pub fn pci2c2(&mut self) -> Pci2c2W<'_, PconpSpec> {
        Pci2c2W::new(self, 26)
    }
    #[doc = "Bit 27 - I2S interface power/clock control bit."]
    #[inline(always)]
    pub fn pci2s(&mut self) -> Pci2sW<'_, PconpSpec> {
        Pci2sW::new(self, 27)
    }
    #[doc = "Bit 28 - SD Card interface power/clock control bit."]
    #[inline(always)]
    pub fn pcsdc(&mut self) -> PcsdcW<'_, PconpSpec> {
        PcsdcW::new(self, 28)
    }
    #[doc = "Bit 29 - GPDMA function power/clock control bit."]
    #[inline(always)]
    pub fn pcgpdma(&mut self) -> PcgpdmaW<'_, PconpSpec> {
        PcgpdmaW::new(self, 29)
    }
    #[doc = "Bit 30 - Ethernet block power/clock control bit."]
    #[inline(always)]
    pub fn pcenet(&mut self) -> PcenetW<'_, PconpSpec> {
        PcenetW::new(self, 30)
    }
    #[doc = "Bit 31 - USB interface power/clock control bit."]
    #[inline(always)]
    pub fn pcusb(&mut self) -> PcusbW<'_, PconpSpec> {
        PcusbW::new(self, 31)
    }
}
...
#[doc = "`reset()` method sets PCONP to value 0x0408_829e"]
impl crate::Resettable for PconpSpec {
    const RESET_VALUE: u32 = 0x0408_829e;
}
