...
pub type R = crate::R<SpificlkselSpec>;
#[doc = "Register `SPIFICLKSEL` writer"]
pub type W = crate::W<SpificlkselSpec>;
...
pub type SpifidivR = crate::FieldReader;
...
pub type SpifidivW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
impl R {
    ...
    pub fn spifisel(&self) -> SpifiselR {
        SpifiselR::new(((self.bits >> 8) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:4 - Selects the divide value for creating the SPIFI clock from the selected clock source. 0 = The divider is turned off., no clock will be provided to the SPIFI. 1 = The input clock is divided by 1 to produce the SPIFI clock. 2 = The input clock is divided by 2 to produce the SPIFI clock. 3 = The input clock is divided by 3 to produce the SPIFI clock. ... 31 = The input clock is divided by 31 to produce the SPIFI clock."]
    #[inline(always)]
    pub fn spifidiv(&mut self) -> SpifidivW<'_, SpificlkselSpec> {
        SpifidivW::new(self, 0)
    }
    #[doc = "Bits 8:9 - Selects the input clock for the USB clock divider."]
    #[inline(always)]
    pub fn spifisel(&mut self) -> SpifiselW<'_, SpificlkselSpec> {
        SpifiselW::new(self, 8)
    }
}
#[doc = "SPIFI Clock Selection register\n\nYou can [`read`](crate::Reg::read) this register and get [`spificlksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spificlksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SpificlkselSpec;
impl crate::RegisterSpec for SpificlkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spificlksel::R`](R) reader structure"]
impl crate::Readable for SpificlkselSpec {}
#[doc = "`write(|w| ..)` method takes [`spificlksel::W`](W) writer structure"]
impl crate::Writable for SpificlkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPIFICLKSEL to value 0"]
impl crate::Resettable for SpificlkselSpec {}
