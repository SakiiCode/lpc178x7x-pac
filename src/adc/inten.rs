...
pub type Adinten0R = crate::BitReader<Enum>;
impl Adinten0R {
...
pub type Adinten0W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Adinten1R = crate::BitReader<Enum>;
impl Adinten1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Adinten1W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Adinten2R = crate::BitReader<Enum>;
impl Adinten2R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Adinten2W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Adinten3R = crate::BitReader<Enum>;
impl Adinten3R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Adinten3W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Adinten4R = crate::BitReader<Enum>;
impl Adinten4R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Adinten4W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Adinten5R = crate::BitReader<Enum>;
impl Adinten5R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Adinten5W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Adinten6R = crate::BitReader<Enum>;
impl Adinten6R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Adinten6W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type Adinten7R = crate::BitReader<Enum>;
impl Adinten7R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type Adinten7W<'a, REG> = crate::BitWriter<'a, REG, Enum>;
...
pub type AdgintenR = crate::BitReader<Enum>;
impl AdgintenR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Enum {
...
pub type AdgintenW<'a, REG> = crate::BitWriter<'a, REG, Enum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn channels(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Channels)
    }
    #[doc = "The global DONE flag in ADDR is enabled to generate an interrupt in addition to any individual ADC channels that are enabled to generate interrupts."]
    #[inline(always)]
    pub fn global(self) -> &'a mut crate::W<REG> {
        self.variant(Enum::Global)
    }
}
impl R {
