...
pub mod dt;
#[doc = "CCP (rw) register accessor: Communication Pattern register\n\nYou can [`read`](crate::Reg::read) this register and get [`ccp::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccp::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ccp`] module"]
#[doc(alias = "CCP")]
pub type Ccp = crate::Reg<ccp::CcpSpec>;
